            ...
            <div className="relative bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 rounded-[32px] p-8 md:p-10 shadow-2xl overflow-hidden transition-colors duration-500 min-h-[600px] flex flex-col">
              ...
              <div className="flex items-center justify-between mb-12 relative px-4">
                ...
                {stepsLabels.map((s) => {
                  ...
                  return (
                    <div key={s.id} className="relative z-10 flex flex-col items-center gap-3 bg-white dark:bg-[#0A0A0A] px-2">
                      <div className={`
              ...
              {isSuccess ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center animate-enter-zoom">
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t.raw("success.desc").replace(/{br}/g, "<br/>") }}
                  />
                  <button
                    onClick={() => {
                      setIsSuccess(false);
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
                  <div className="flex-1 relative overflow-hidden">
                    ...
                    {/* STEP 1: INFORMATIONS */}
                    <div className={`absolute inset-0 transition-all duration-500 ease-in-out flex flex-col gap-5 ${step === 1 ? 'opacity-100 translate-x-0 z-10' : 'opacity-0 -translate-x-full pointer-events-none'}`}>
                      <div className="space-y-5">
                        <div className="relative group">
                          ...
                          <input
                            type="text" placeholder={t("form.namePlaceholder")}
                        ...
                        <div className="relative group">
                          ...
                          <input
                            type="email" placeholder={t("form.emailPlaceholder")}
                        ...
                        <div className="relative group">
                          ...
                          <input
                            type="text" placeholder={t("form.companyPlaceholder")}
                        ...
                        <div className="relative group">
                          <label className="absolute left-4 top-2 text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t("form.employeesLabel")}</label>
                          <select
                    ...
                    {/* STEP 2: SERVICES */}
                    <div className={`absolute inset-0 transition-all duration-500 ease-in-out flex flex-col ${step === 2 ? 'opacity-100 translate-x-0 z-10' : step < 2 ? 'opacity-0 translate-x-full pointer-events-none' : 'opacity-0 -translate-x-full pointer-events-none'}`}>
                      <label className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-6 block">{t("form.serviceLabel")}</label>
                          ...
                          return (
                            <div
                              ...
                              className={`
                                 ...
                                 `}
                            >
                              <srv.icon size={24} className={isSelected ? 'text-white' : 'group-hover:text-black dark:group-hover:text-white transition-colors'} />
                    ...
                    {/* STEP 3: DETAILS */}
                    <div className={`absolute inset-0 transition-all duration-500 ease-in-out flex flex-col gap-6 ${step === 3 ? 'opacity-100 translate-x-0 z-10' : 'opacity-0 translate-x-full pointer-events-none'}`}>
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-widest flex items-center gap-2">
                          <MessageSquare size={14} /> {t("form.projectDescLabel")}
                        </label>
                        <textarea
