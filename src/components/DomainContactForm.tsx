            ...
            <div className="relative bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 rounded-[32px] p-8 md:p-10 shadow-2xl overflow-hidden transition-colors duration-500 min-h-[600px] flex flex-col">
              ...
              {isSuccess ? (
                 <div className="flex-1 flex flex-col items-center justify-center text-center animate-enter-zoom">
                    ...
                    <h3 className="text-3xl font-black text-black dark:text-white mb-4">Message Envoyé !</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-10 text-lg">Votre projet est entre de bonnes mains.<br/>Nous vous recontactons sous 24h.</p>
                    <button 
                      onClick={() => {
                          setIsSuccess(false); 
                          setStep(1);
                  ...
                  <div className="flex-1 relative overflow-hidden">
                    ...
                    <div className={`absolute inset-0 transition-all duration-500 ease-in-out flex flex-col gap-5 ${step === 1 ? 'opacity-100 translate-x-0 z-10' : 'opacity-0 -translate-x-full pointer-events-none'}`}>
                        <div className="space-y-5">
                            ...
                            <div className="relative group">
                                <label className="absolute left-4 top-2 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Nombre d'employés *</label>
                                <select 
