      ...
      <div className="max-w-[1700px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 bg-[#0A0A0A] dark:bg-black rounded-[48px] p-10 md:p-14 border border-white/5 flex flex-col justify-between relative overflow-hidden group shadow-2xl">
             ...
             <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-gray-400">Canal Prioritaire</span>
                </div>
                
                <h3 className="text-3xl md:text-5xl font-black mb-10 leading-[0.9] text-white tracking-tighter uppercase">
                   Contactez <br/>
                   <span className="text-brand-red underline decoration-red-900/50 underline-offset-8">Nos Experts</span> <br/>
                   en Apps.
                </h3>
                
                <div className="space-y-8">
                   <div className="group/link cursor-pointer">
                      <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Ligne Directe</p>
                   ...
                   <div className="group/link cursor-pointer">
                      <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Canal Officiel</p>
             ...
             <div className="mt-16 pt-10 border-t border-white/5 flex items-center justify-between opacity-50 group-hover:opacity-100 transition-opacity">
                <span className="text-[9px] font-black uppercase tracking-[0.3em]">Marrakech HQ • v2.5</span>
          ...
          <div className="lg:col-span-5 bg-white dark:bg-[#0A0A0A] rounded-[48px] p-10 md:p-14 border border-black/5 dark:border-white/10 relative overflow-hidden group shadow-2xl backdrop-blur-3xl">
             ...
             <div className="relative z-10 h-full flex flex-col justify-center">
                <div className="text-center mb-10">
                    <h3 className="text-xl md:text-2xl font-black text-black dark:text-white tracking-tighter uppercase mb-2">Formulaire de Projet</h3>
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Une réponse sous 12 cycles horaires</p>
                </div>
                ...
                <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button className="group/btn w-full py-6 bg-brand-red hover:bg-red-600 text-white font-black uppercase tracking-[0.3em] text-[10px] rounded-[2rem] shadow-2xl shadow-red-900/30 hover:scale-[1.03] active:scale-95 transition-all flex items-center justify-center gap-4 overflow-hidden relative">
                       <span className="relative z-10">INITIALISER LE PROTOCOLE</span>
                    ...
                    <p className="text-[8px] font-black text-center text-gray-400 dark:text-gray-600 uppercase tracking-widest">Sécurisé par Chiffrement GDC Elite</p>
                </form>
             </div>
          </div>
          ...
          <div className="lg:col-span-3 bg-white dark:bg-[#0A0A0A] rounded-[48px] p-10 border border-black/5 dark:border-white/10 flex flex-col items-center justify-center text-center shadow-xl backdrop-blur-xl group hover:border-brand-red/20 transition-all duration-500">
             ...
             <h3 className="text-xl font-black mb-8 text-black dark:text-white uppercase tracking-tighter">
               UPTIME <br/> <span className="text-gray-400">OPÉRATIONNEL</span>
             </h3>
             
             <div className="space-y-6">
                <div className="flex flex-col items-center">
                   <div className="px-4 py-1.5 rounded-full bg-brand-red/10 border border-brand-red/20 mb-4">
                      <span className="text-[10px] font-black text-brand-red uppercase tracking-widest">Lundi au Vendredi</span>
                   </div>
