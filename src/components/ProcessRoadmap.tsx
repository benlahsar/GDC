        ...
        <div className="relative bg-white dark:bg-[#020202] transition-colors duration-500">
            ...
            <div className="md:hidden py-16 px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-black text-black dark:text-white tracking-tight mb-4 leading-tight" dangerouslySetInnerHTML={{ __html: t.raw("mobile.title").replace(/{br}/g, "<br/>").replace(/{span}/g, `<span class="text-brand-red">${t("mobile.titleHighlight")}</span>`) }} />
                ...
                <div ref={stickyRef} className="sticky top-0 h-screen overflow-hidden flex flex-col justify-center items-center bg-white dark:bg-[#020202] transition-colors duration-500">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-black dark:text-white tracking-tight mb-4 leading-tight">
                            {t.raw("desktop.title").replace(/{span}/g, "")} <span className="text-brand-red">{t("desktop.titleHighlight")}</span>
                        </h2>
                        ...
                        <p
                            ...
                            dangerouslySetInnerHTML={{ __html: t.raw("desktop.description").replace(/{br}/g, "<br className='hidden md:block'/>").replace(/<highlight>/g, "<span class='text-brand-red font-bold'>").replace(/<\/highlight>/g, "</span>") }}
                        />
                    </div>
                ...
                <div className="max-w-5xl mx-auto rounded-[50px] p-12 md:p-16 text-center overflow-hidden border border-black/5 dark:border-white/10 bg-gray-50 dark:bg-gradient-to-br dark:from-[#111] dark:via-[#050505] dark:to-black relative group shadow-xl dark:shadow-2xl">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2
                            ...
                            dangerouslySetInnerHTML={{ __html: t.raw("cta.title").replace(/{br}/g, "<br/>").replace(/{span}/g, `<span class="text-brand-red">${t("cta.titleHighlight")}</span>`) }}
                        />
