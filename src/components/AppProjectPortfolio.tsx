...
export const AppProjectPortfolio: React.FC = () => {
  const t = useTranslations("AppProjectPortfolio");
    ...
    <section className="relative w-full py-24 md:py-32 bg-[#F0F0F2] dark:bg-[#000000] overflow-hidden transition-colors duration-500 border-t border-black/5 dark:border-white/5">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1700px] relative z-10">
        ...
        <div className={`text-center mb-16 md:mb-24`}>
          ...
          <h2
            className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter text-black dark:text-white uppercase mb-8"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {(t.raw("items") as any[]).map((project, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              >
                {!isMobile && (
                  <>
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-tr ${project.accent} opacity-40 group-hover:opacity-80 transition-opacity`}
                    ></div>
                  </>
                )}
                ...
                <div
                  ...
                  style={{
                    animationDelay: !isMobile ? `${idx * 500}ms` : "0ms",
                  }}
                >
                  <img
                    src={project.logo}
                ...
                <div
                  className={`absolute bottom-6 right-6 w-12 h-12 rounded-full bg-brand-red text-white flex items-center justify-center shadow-lg shadow-red-900/30 ${
                    !isMobile
              ...
              <div className="mt-8 text-center px-4">
                <h3
                  className={`text-sm md:text-base font-black text-black dark:text-white uppercase tracking-wider leading-tight transition-colors min-h-[40px] flex items-center justify-center ${
                ...
                <div
                  className={`w-1.5 h-1.5 rounded-full bg-brand-red/20 mx-auto mt-4 transition-all duration-500 ${
                    !isMobile
                      ? "group-hover:w-12 group-hover:h-1 group-hover:bg-brand-red"
                      : "bg-brand-red"
                  }`}
                ></div>
              </div>
