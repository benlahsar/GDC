...
export const EcommerceFinalCTA: React.FC = () => {
  ...
  return (
    <section className="relative w-full py-24 md:py-32 bg-[#F0F0F2] dark:bg-[#050505] overflow-hidden flex flex-col items-center justify-center transition-colors duration-500 border-t border-black/5 dark:border-white/5">
       ...
       <div className="relative w-full max-w-[1200px] h-[700px] md:h-[800px] flex justify-center items-end">
          ...
          >
              ...
              <div className={`absolute inset-0 bg-gradient-to-b from-[#ec4899] via-[#a855f7] to-[#6366f1] opacity-90 ${!isMobile ? 'animate-pulse-slow' : ''}`}></div>
              {!isMobile && (
                <div 
          ...
          <div className="absolute top-[10%] md:top-[15%] z-20 flex flex-col items-center text-center px-4 w-full">
              ...
              >
                  ...
                  <div className={`w-6 h-6 rounded-full bg-white/20 flex items-center justify-center relative z-10 ${!isMobile ? 'group-hover:bg-white group-hover:text-[#1e1b4b] transition-colors' : ''}`}>
                      <ArrowRight size={14} className={!isMobile ? 'group-hover:-rotate-45 transition-transform' : ''} />
                  </div>
              </a>
          ...
          <div className="relative z-20 w-[200px] md:w-[300px] h-[120px] md:h-[160px] mb-[-20px] md:mb-[-40px]">
              <div className="
                  w-full h-full 
                  bg-gradient-to-b from-cyan-400 to-cyan-600 
                  rounded-b-[60px] md:rounded-b-[100px] 
              ...
              ">
                  ...
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-16 h-16 bg-white/10 rounded-full blur-sm border border-white/20 flex items-center justify-center">
                      <div className="w-10 h-10 bg-cyan-100 rounded-full -translate-x-2 -translate-y-2 blur-[1px]"></div>
                  </div>
              </div>
              <div className="absolute -top-6 left-0 w-full h-[50px] bg-gradient-to-r from-cyan-300 to-cyan-500 rounded-[50%] opacity-90 border-t border-white/40 shadow-inner"></div>
          </div>
