            ...
            <div className="relative w-full max-w-xl bg-white dark:bg-[#0E0E0E] rounded-[40px] border border-black/10 dark:border-white/10 shadow-2xl overflow-hidden p-8 md:p-12 animate-enter-bottom">
                ...
                {resSuccess ? (
                    <div className="text-center py-10 animate-fade-in-up">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Nous avons bien reçu votre demande de réservation pour <strong className="text-black dark:text-white underline decoration-emerald-500 decoration-2">{searchResult?.domain}</strong>.</p>
                        <p className="text-xs mt-6 text-gray-400 font-bold uppercase tracking-widest">Un expert GDC vous contactera sous peu.</p>
                    </div>
                ) : (
                    <div className="space-y-8">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-red/10 border border-brand-red/20 text-brand-red mb-4">
                                <Lock size={12} />
                                <span className="text-[10px] font-black uppercase tracking-widest">Sécurisation Prioritaire</span>
                            </div>
                            <h3 className="text-3xl md:text-4xl font-black tracking-tight leading-[0.9] uppercase">
                                RÉSERVER <br/>
                                <span className="text-brand-red italic">{searchResult?.domain}</span>
                            </h3>
                        </div>

                        <form onSubmit={handleReserveSubmit} className="space-y-4">
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 ml-2 group-focus-within:text-brand-red transition-colors">Nom Complet</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2 group">
                                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 ml-2 group-focus-within:text-brand-red transition-colors">Email</label>
                                    <div className="relative">
                                ...
                                <div className="space-y-2 group">
                                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 ml-2 group-focus-within:text-brand-red transition-colors">Téléphone</label>
                                    <div className="relative">
                            ...
                            >
                                {isResSubmitting ? <Loader2 className="animate-spin" /> : <>CONFIRMER LA RÉSERVATION <Send size={16}/></>}
                            </button>
                        </form>
                        <p className="text-[9px] text-center text-gray-400 font-bold uppercase tracking-widest leading-relaxed">
                            En validant ce formulaire, vous initiez une procédure d'acquisition <br/> assistée par le pôle technique GDC.
                        </p>
                    </div>
                )}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12">
            ...
            `}>
                ...
                <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-red/10 border border-brand-red/20 text-brand-red mb-8 backdrop-blur-md">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em]">Système de Registre en Direct</span>
                    </div>

                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-[1] mb-8 text-black dark:text-white uppercase">
                        Vérification <br/>
                        Réelle de <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-red-600">Noms de Domaine.</span>
                    </h1>
                    ...
                    <div className="relative mb-12 max-w-xl group/searchbox">
                        <form onSubmit={handleCheckDomain} className="relative">
                            ...
                            `}>
                                ...
                                <input 
                                    type="text" 
                                    placeholder="Rechercher votre domaine..."
                                ...
                                >
                                    {isChecking ? <Loader2 size={16} className="animate-spin" /> : <>VÉRIFIER <ArrowRight size={14}/></>}
                                </button>
                            </div>
                        </form>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className={`text-[10px] font-black uppercase tracking-widest ${searchResult.available ? 'text-emerald-600' : 'text-brand-red'}`}>
                                            {searchResult.available ? 'Disponible immédiatement' : 'Déjà enregistré'}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="pl-6 border-l-2 border-brand-red mb-10">
                        <p className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-2">
                            Base de données ICANN & ANRT Synchronisée
                        </p>
                        <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 font-medium leading-relaxed max-w-2xl">
                            Obtenez un statut réel sur la disponibilité de votre identité web en moins de 2 secondes.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="#contact" className={`group px-8 py-4 bg-black dark:bg-white text-white dark:text-black rounded-2xl font-bold uppercase tracking-widest text-xs transition-all shadow-lg flex items-center gap-2 ${!isMobile ? 'hover:scale-105' : ''}`}>
                            Conseils d'experts <ArrowRight size={16} className={!isMobile ? "group-hover:translate-x-1 transition-transform" : ""} />
                        </a>
                    </div>
                </div>
            </div>
            ...
            `}>
                ...
                <div className="relative z-10 mt-auto">
                    <h3 className="text-4xl font-black text-white mb-6 leading-[0.85] uppercase tracking-tighter">
                        Premier arrivé, <br/>
                        <span className="text-brand-red italic">Premier servi.</span>
                    </h3>
                    <div className="flex items-center gap-3">
                         <div className="px-3 py-1 rounded-lg bg-white/5 border border-white/10">
                            <span className="text-[8px] font-black text-gray-500 uppercase tracking-widest">GDC Live Hub v.4</span>
                         </div>
            ...
            `}>
                ...
                <h3 className="text-2xl font-black text-black dark:text-white mb-4">Processus Complet</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base leading-relaxed">
                    Notre processus inclut une <strong className="text-black dark:text-white">analyse approfondie de votre secteur</strong>, une recherche stratégique de disponibilité pour éviter les conflits, et des conseils personnalisés.
                </p>
            </div>
            ...
            `}>
                ...
                <h3 className="text-2xl font-black text-black dark:text-white mb-4">Sécurité & Expertise</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base leading-relaxed">
                    En choisissant notre service, vous bénéficiez d'un partenariat avec une équipe reconnue pour sa <strong className="text-black dark:text-white">réactivité</strong> et son expertise.
                </p>
            </div>
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-12 gap-6 ${!isMobile ? 'opacity-0 animate-fade-in-up delay-400' : ''}`}>
            ...
            <div className="col-span-1 lg:col-span-7 bg-black dark:bg-[#111] rounded-[40px] p-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-8 text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="text-center md:text-left relative z-10">
                    ...
                    <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mt-2">Délai d'Acquisition</p>
                </div>
                ...
                <div className="text-center md:text-left relative z-10">
                    ...
                    <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mt-2">Satisfaction Client</p>
                </div>
