              ...
              <div className="space-y-6 text-base md:text-lg text-gray-600 dark:text-gray-400 font-medium leading-relaxed max-w-3xl mb-12 border-l-2 border-brand-red pl-6">
                <p>
                  ...
                  <strong className="text-black dark:text-white">
                    expert en création d'application Marrakech
                  </strong>{" "}
                  pour concrétiser votre projet digital ? Group Digital Concept
                  vous accompagne dans le développement d'applications mobiles
                  et web sur mesure.
                </p>
                <p>
                  Nous combinons{" "}
                  <strong className="text-black dark:text-white">
                    technologie avancée et expérience utilisateur
                  </strong>{" "}
                  pour créer des applications intuitives, modernes et efficaces.
                  En moins de 30 jours, nous vous aidons à donner vie à votre
                  application.
                </p>
              </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <div className="flex flex-col items-center lg:items-end gap-6 w-full lg:w-auto">
                <p className="text-center lg:text-right text-sm font-bold text-gray-500 dark:text-gray-400 max-w-sm">
                  Group Digital Concept transforme vos idées en solutions
                  digitales concrètes.
                </p>
                <a
                  href="#contact"
