      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1600px] relative z-10">
        ...
        <div className="text-center mb-20 md:mb-28">
           <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-black/5 dark:border-white/10 bg-white/40 dark:bg-white/5 backdrop-blur-md mb-8 shadow-sm">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-800 dark:text-gray-200">Expansion Nationale</span>
           </div>
           <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter text-black dark:text-white uppercase">
            Notre Expertise en <span className="text-brand-red">Création d'Application</span> au Maroc
           </h2>
          ...
          {REGIONAL_DETAILS.map((item, idx) => (
            <div 
              ...
              className="
                ...
                border-2 border-brand-red shadow-2xl shadow-brand-red/5
                overflow-hidden transition-all duration-700
                hover:shadow-brand-red/10 hover:-translate-y-1
            ...
            >
              ...
              <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                <div className="mb-6">
                  <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.4em] text-brand-red mb-3 block">Group Digital Concept</span>
                ...
                <div className="flex items-center gap-4 mt-auto">
                   ...
                   <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 group-hover:text-brand-red transition-colors">Découvrir le projet</span>
                </div>
              </div>
