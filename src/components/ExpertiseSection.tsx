            ...
            <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1600px] relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-16 md:mb-24">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tight text-black dark:text-white mb-8 max-w-5xl">
                        {t("title")} <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-red-600">{t("highlight")}</span>
                    </h2>

                    <p
                        className="max-w-3xl text-xl md:text-2xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: t.raw("description").replace(/<highlight>/g, '<span class="text-black dark:text-white font-bold">').replace(/<\/highlight>/g, "</span>") }}
                    />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 auto-rows-fr">
                    ...
                    <div className={`md:col-span-1 lg:col-span-2 group relative p-6 md:p-6 lg:p-10 rounded-[32px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 overflow-hidden ${!isMobile ? 'hover:shadow-2xl' : ''} transition-all duration-500`}>
                        ...
                        <div className="relative z-10 flex flex-col lg:flex-row gap-6 md:gap-6 lg:gap-8 items-start lg:items-center">
                            ...
                            <div>
                                <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-black dark:text-white mb-2 md:mb-0 lg:mb-3">{t("features.design.title")}</h3>
                                <p
                                    className="text-gray-600 dark:text-gray-400 text-sm md:text-base lg:text-lg leading-relaxed"
                                    dangerouslySetInnerHTML={{ __html: t.raw("features.design.desc").replace(/<highlight>/g, '<span class="font-semibold text-black dark:text-white">').replace(/<\/highlight>/g, "</span>") }}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={`group relative p-6 md:p-6 lg:p-8 rounded-[32px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 overflow-hidden ${!isMobile ? 'hover:shadow-xl' : ''} transition-all duration-500 flex flex-col`}>
                        ...
                        <h3 className="text-lg md:text-lg lg:text-xl font-bold text-black dark:text-white mb-2 md:mb-0 lg:mb-3">{t("features.performance.title")}</h3>
                        <p
                            className="text-gray-600 dark:text-gray-400 text-sm md:text-base lg:text-lg leading-relaxed"
                            dangerouslySetInnerHTML={{ __html: t.raw("features.performance.desc") }}
                        />
                    </div>
                    ...
                    <div className={`group relative p-6 md:p-6 lg:p-8 rounded-[32px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 overflow-hidden ${!isMobile ? 'hover:shadow-xl' : ''} transition-all duration-500 flex flex-col`}>
                        ...
                        <h3 className="text-lg md:text-lg lg:text-xl font-bold text-black dark:text-white mb-2 md:mb-0 lg:mb-3">{t("features.seo.title")}</h3>
                        <p
                            className="text-gray-600 dark:text-gray-400 text-sm md:text-base lg:text-lg leading-relaxed"
                            dangerouslySetInnerHTML={{ __html: t.raw("features.seo.desc") }}
                        />
                    </div>
                    ...
                    <div className={`lg:col-start-3 lg:row-start-1 lg:row-span-2 relative group rounded-[32px] bg-[#080808] border border-white/10 overflow-hidden flex flex-col justify-between p-6 md:p-6 lg:p-10 shadow-2xl`}>
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-6 lg:mb-8">
                                ...
                                <h3 className="text-lg lg:text-xl font-black text-white uppercase tracking-wide" dangerouslySetInnerHTML={{ __html: t.raw("impact.title").replace(/<br\/>/g, "<br/>") }} />
                            </div>
                            ...
                            <div className="space-y-2 lg:space-y-8">
                                ...
                                <div className={`relative pl-4 border-l-2 border-brand-red/30 ${!isMobile ? 'group-hover:border-brand-red' : ''} transition-colors duration-500`}>
                                    ...
                                    <p className="text-gray-400 text-[10px] md:text-xs lg:text-sm font-bold uppercase tracking-wider leading-relaxed">{t("impact.stat1")}</p>
                                </div>
                                ...
                                <div className={`relative pl-4 border-l-2 border-blue-500/30 ${!isMobile ? 'group-hover:border-blue-500' : ''} transition-colors duration-500`}>
                                    ...
                                    <p className="text-gray-400 text-[10px] md:text-xs lg:text-sm font-bold uppercase tracking-wider leading-relaxed">{t("impact.stat2")}</p>
                                </div>
                                ...
                                <div className={`relative pl-4 border-l-2 border-emerald-500/30 ${!isMobile ? 'group-hover:border-emerald-500' : ''} transition-colors duration-500`}>
                                    ...
                                    <p className="text-gray-400 text-[10px] md:text-xs lg:text-sm font-bold uppercase tracking-wider leading-relaxed">{t("impact.stat3")}</p>
                                </div>
                                ...
                                <div className={`relative pl-4 border-l-2 border-amber-500/30 ${!isMobile ? 'group-hover:border-amber-500' : ''} transition-colors duration-500`}>
                                    ...
                                    <p className="text-gray-400 text-[10px] md:text-xs lg:text-sm font-bold uppercase tracking-wider leading-relaxed">{t("impact.stat4")}</p>
                                </div>
                            </div>
                        </div>
