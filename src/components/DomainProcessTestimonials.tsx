          ...
          <div className={`lg:col-span-5 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="sticky top-32">
              ...
              <h2
                ...
                dangerouslySetInnerHTML={{ __html: t.raw("header.title").replace(/{br}/g, "<br/>") + `<span class="inline-block ml-2"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 md:w-12 md:h-12 text-brand-red"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>` }}
              />
