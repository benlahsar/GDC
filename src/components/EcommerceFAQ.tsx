...
const FAQS = [
  {
    question: "Pourquoi est-il important d'avoir un site e-commerce ?",
    answer: "Avoir un site e-commerce permet d'atteindre une audience plus large, d'augmenter vos ventes en ligne et de proposer vos produits 24h/24."
  },
  {
    question: "Combien coûte la création d'un site e-commerce ?",
    answer: "Le coût varie selon la complexité du projet. Nous proposons des solutions adaptées à tous les budgets, du site Shopify au sur-mesure."
  },
  {
    question: "Quelle est la meilleure plateforme e-commerce ?",
    answer: "Cela dépend de vos objectifs. Shopify est excellent pour un lancement rapide, WooCommerce offre une flexibilité totale."
  },
  {
    question: "Combien de temps faut-il pour créer une boutique ?",
    answer: "En moyenne, un projet e-commerce prend entre 4 à 8 semaines, de la conception au lancement."
  },
  {
    question: "Comment optimiser mon site pour le SEO ?",
    answer: "Nous optimisons la structure technique, les fiches produits, les méta-données et le maillage interne."
  }
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                ...
                <div className="lg:col-span-5">
                    <div className="lg:sticky lg:top-32">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tighter leading-[0.95] text-black dark:text-white mb-6">
                            Explorez les <br/>
                            questions <br/>
                        ...
                        <div className={`p-6 rounded-[24px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-xl relative overflow-hidden group ${!isMobile ? 'hover:-translate-y-1 transition-transform duration-300' : ''}`}>
                             ...
                             <div className="relative z-10">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-lg text-black dark:text-white">Question spécifique ?</h4>
                                ...
                                <a href="#contact" className="flex items-center justify-between w-full px-6 py-4 rounded-xl bg-black dark:bg-white text-white dark:text-black font-bold text-xs uppercase tracking-widest hover:shadow-lg transition-all group/btn">
                                    Contactez-nous <ArrowRight size={16} className={!isMobile ? 'group-hover/btn:translate-x-1 transition-transform' : ''} />
                                </a>
                             </div>
                        </div>
                    </div>
                        ...
                        <div 
                            ...
                            className={`
                                ...
                                ${openIndex === index 
                                    ...
                                    : 'bg-white/40 dark:bg-white/5 hover:bg-white dark:hover:bg-[#0A0A0A] border border-black/5 dark:border-white/5'
                                }
                            `}
                        >
                            <div className="p-6 md:p-8">
                                ...
                                <div 
                                    className={`
                                        ...
                                        ${openIndex === index ? 'grid-rows-[1fr] opacity-100 mt-6' : 'grid-rows-[0fr] opacity-0 mt-0'}
                                    `}
                                >
