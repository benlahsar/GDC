...
export const DomainWhyChooseSection: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-24 bg-[#F0F0F2] dark:bg-[#050505] text-black dark:text-white transition-colors duration-500 overflow-hidden border-t border-black/5 dark:border-white/5"
    >
      {/* Background Ambience */}
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1600px] relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 auto-rows-min">
          ...
          <div
            className={`lg:col-span-8 bg-white dark:bg-[#0A0A0A] rounded-[40px] p-8 md:p-12 border border-black/5 dark:border-white/10 flex flex-col justify-center shadow-xl transition-all duration-700 ease-out ${
              isVisible
          ...
          <div
            className={`lg:col-span-4 bg-[#111] dark:bg-[#151515] text-white rounded-[40px] p-8 md:p-10 border border-white/10 relative overflow-hidden group flex flex-col justify-between transition-all duration-700 delay-100 ease-out ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          ...
          <div className="lg:col-span-12 grid grid-cols-1 lg:grid-cols-12 gap-6">
            {FEATURES.map((feature, index) => (
              <div
                ...
                className={`${
                  feature.colSpan
                } bg-[#F5F5F7] dark:bg-[#0A0A0A] rounded-[32px] p-8 border border-black/5 dark:border-white/10 hover:border-brand-red/20 dark:hover:border-brand-red/20 hover:bg-white dark:hover:bg-[#111] transition-all duration-500 group flex flex-col ${
                  isVisible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-10"
                }`}
              ...
              >
                ...
                <h4 className="text-lg font-bold text-black dark:text-white mb-3 group-hover:text-brand-red transition-colors">
                  {feature.title}
                </h4>
          ...
          <div
            className={`lg:col-span-6 bg-white dark:bg-[#0A0A0A] rounded-[40px] p-8 md:p-12 border border-black/5 dark:border-white/10 flex flex-col justify-center shadow-lg transition-all duration-700 delay-500 ease-out ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-black uppercase tracking-wide text-black dark:text-white">
                {t("mission.title")}
              </h3>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {["Simplifier", "Sécuriser", "Optimiser"].map((tag, i) => (
                <span
                  key={i}
                  className="px-3 py-1 rounded-full bg-gray-100 dark:bg-white/5 text-[10px] font-bold uppercase text-gray-600 dark:text-gray-300 border border-black/5 dark:border-white/5"
                >
                  {t(`mission.tags.${i}`)}
                </span>
              ))}
          ...
          <div
            className={`lg:col-span-6 bg-gradient-to-br from-brand-red to-red-800 text-white rounded-[40px] p-8 md:p-12 relative overflow-hidden group flex flex-col justify-center shadow-xl shadow-red-900/20 transition-all duration-700 delay-600 ease-out ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            ...
            <div className="relative z-10">
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest bg-white text-brand-red px-6 py-3 rounded-full hover:bg-black hover:text-white transition-all shadow-lg"
              >
