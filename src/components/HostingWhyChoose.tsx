...
export const HostingWhyChoose: React.FC = () => {
  ...
  const REASONS = [
    { id: "performance", title: t("reasons.performance.title"), desc: t("reasons.performance.desc"), icon: Zap, color: "text-yellow-500", bg: "bg-yellow-500/10" },
    { id: "security", title: t("reasons.security.title"), desc: t("reasons.security.desc"), icon: ShieldCheck, color: "text-emerald-500", bg: "bg-emerald-500/10" },
    { id: "hosting", title: t("reasons.hosting.title"), desc: t("reasons.hosting.desc"), icon: Server, color: "text-blue-500", bg: "bg-blue-500/10" },
    { id: "backup", title: t("reasons.backup.title"), desc: t("reasons.backup.desc"), icon: Database, color: "text-purple-500", bg: "bg-purple-500/10" },
    { id: "support", title: t("reasons.support.title"), desc: t("reasons.support.desc"), icon: Headset, color: "text-cyan-500", bg: "bg-cyan-500/10" },
    { id: "engagement", title: t("reasons.engagement.title"), desc: t("reasons.engagement.desc"), icon: HeartHandshake, color: "text-brand-red", bg: "bg-brand-red/10" }
  ];
          ...
          <div className={`lg:col-span-5 flex flex-col gap-6 ${!isMobile ? 'transition-all duration-1000 delay-400' : ''} ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-black text-white mb-6 uppercase tracking-tight">{t("vision.title")}</h3>
                <div className="space-y-4 text-gray-300 text-sm md:text-base leading-relaxed font-medium">
                  <p dangerouslySetInnerHTML={{ __html: t.raw("vision.p1").replace(/<highlight>/g, `<strong class="text-white">`).replace(/<\/highlight>/g, "</strong>") }} />
                  <p>{t("vision.p2")}</p>
                </div>
              </div>
            </div>
            ...
            <div className="
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-black text-black mb-6 uppercase tracking-tight">{t("mission.title")}</h3>
