...
export const AgencyEngagement: React.FC<{ isMobile?: boolean }> = ({ isMobile }) => {
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 max-w-[1600px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
            ...
            <div className={`
                ...
                ${isVisible ? 'opacity-100 translate-x-0' : `opacity-0 ${!isMobile ? '-translate-x-10' : ''}`}
            `}>
                ...
                <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 mb-8 backdrop-blur-md">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-300">Notre Standard</span>
                    </div>

                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-[1.05] mb-8">
                        Un Engagement <br/>
                        Inébranlable pour <br/>
                    ...
                    <div className="space-y-6 text-gray-400 font-medium text-base md:text-lg leading-relaxed max-w-2xl">
                        <p>
                            Chez <strong className="text-white">Group Digital Concept</strong>, l’excellence n’est pas une option, c'est notre signature. Nous déployons des stratégies digitales de haute précision pour garantir votre suprématie sur le marché.
                        </p>
                    </div>
                </div>
                ...
                <div className="relative z-10 mt-12 flex items-center justify-between border-t border-white/10 pt-8">
                    <div className="flex gap-4">
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Engagement</span>
                        </div>
                    ...
                    <div className={`w-12 h-12 rounded-full border border-white/20 flex items-center justify-center transition-all duration-300 ${!isMobile ? 'md:group-hover:bg-white md:group-hover:text-black' : ''}`}>
                        <Target size={20} />
                    </div>
                </div>
            </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
                <div className={`
                    ...
                    ${isVisible ? 'opacity-100 translate-y-0' : `opacity-0 ${!isMobile ? 'translate-y-10' : ''}`}
                `}>
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-center">
                        <h3 className="text-3xl md:text-4xl lg:text-5xl text-black dark:text-white font-serif leading-tight">
                            Placer <i className="font-serif text-brand-red">Nos Clients</i> <br/>
                            au <i className="font-serif">Cœur</i> de <br/>
                            Chaque Projet.
                        </h3>
                    </div>
                </div>
                ...
                `}>
                    <div className="relative z-10 h-full flex flex-col justify-between gap-6">
                        <p className="text-gray-600 dark:text-gray-300 font-medium text-base leading-relaxed">
                            Nous croyons que le succès naît d'une écoute active. Nous construisons des relations durables, transformant chaque défi en opportunité.
                        </p>
                        
                        <div className="space-y-4">
                            <div className="h-[1px] w-full bg-black/10 dark:bg-white/10"></div>
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-bold uppercase tracking-widest text-black dark:text-white">Votre vision, notre mission</span>
                                <a href="#contact" className="group/btn flex items-center gap-3 px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-full font-bold text-xs uppercase tracking-wider md:hover:scale-105 transition-all shadow-lg">
                                    Démarrer <ArrowRight size={14} className="md:group-hover/btn:translate-x-1 transition-transform" />
                                </a>
                            </div>
                        </div>
                    </div>
