...
export const ComeWithUsPage: React.FC = () => {
  ...
  const MASTERPIECES = [
    {
      ...
      isPortrait: false,
      story:
        "Pour ce projet iconique, GDC a orchestré une séance à l'heure bleue. Nous avons aidé l'agence à capturer la symétrie parfaite entre l'eau et l'architecture.",
    ...
    },
    {
      ...
      isPortrait: false,
      story:
        "Capturer la force brutale de l'Atlantique. Notre équipe a fourni l'expertise drone et le filtrage ND pour des poses longues cinématographiques.",
    ...
    },
    {
      ...
      isPortrait: true,
      story:
        "Un défi de plage dynamique extrême. GDC a supervisé la capture HDR pour préserver les détails dans les ombres de la grotte et les hautes lumières de l'océan.",
    ...
    },
    {
      ...
      isPortrait: false,
      story:
        "Sublimer la verticalité historique. Nous avons aidé Come With Us à isoler le monument des éléments urbains parasites pour un rendu purement artistique.",
    ...
    },
    {
      ...
      isPortrait: false,
      story:
        "Le sommet de notre aide technique. Pour magnifier cette porte ancestrale, nous avons intégré numériquement le logo de l'agence de manière imperceptible.",
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] dark:bg-[#020202] text-black dark:text-white transition-colors duration-700 font-sans selection:bg-brand-red selection:text-white pb-0">
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/95 backdrop-blur-3xl animate-enter-zoom p-4 md:p-12">
          ...
          <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-[32px]">
            <img
              src={selectedImage}
              className="max-w-full max-h-full object-contain shadow-2xl rounded-2xl animate-enter-zoom"
              alt="Vue HD"
            />
          </div>
        </div>
      ...
      <section className="relative pt-48 md:pt-48 pb-12 px-4 md:px-8 lg:px-12 max-w-[1800px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-8 lg:row-span-2 min-h-[480px] lg:min-h-[650px] relative group rounded-[40px] md:rounded-[56px] overflow-hidden bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-2xl transition-all duration-700 hover:shadow-brand-red/5">
            ...
            <div className="relative z-10 h-full p-8 md:p-14 lg:p-20 flex flex-col justify-end">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-9xl font-black tracking-tighter leading-[0.85] text-black dark:text-white uppercase mb-8">
                Redéfinir le <br />
                Voyage par <br />
                <span className="text-brand-red italic underline decoration-brand-red/20 underline-offset-[16px]">
                  l'Image.
                </span>
              </h1>
              ...
              <p className="text-lg md:text-2xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed max-w-2xl mb-12 border-l-2 border-brand-red pl-6">
                Collaboration stratégique GDC x{" "}
                <strong className="text-black dark:text-white underline decoration-brand-red decoration-2 underline-offset-4">
                  Come With Us
                </strong>
                . Porter les récits d'expédition vers de nouveaux sommets
                digitaux.
              </p>
          ...
          <div className="lg:col-span-4 min-h-[250px] md:min-h-0 flex flex-col items-center justify-center relative overflow-hidden group">
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-max">
              <span className="text-[9px] font-black uppercase tracking-[0.5em] text-gray-500 dark:text-white/40 group-hover:text-brand-red transition-colors">
                Official Partner
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 min-h-[300px] md:min-h-0 rounded-[40px] md:rounded-[56px] p-8 md:p-10 bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-xl flex flex-col justify-between relative overflow-hidden group hover:border-brand-red/30 transition-all duration-500">
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-black text-black dark:text-white uppercase tracking-tight mb-2">
                Expédition <br />
                Actuelle
              </h3>
            ...
            <div className="pt-6 border-t border-black/5 dark:border-white/5 flex items-center justify-between">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full border-2 border-white dark:border-black bg-gray-200 overflow-hidden"
                  >
                    <img
          ...
          <div className="lg:col-span-12 grid grid-cols-2 md:grid-cols-4 gap-[1px] bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-[40px] md:rounded-[56px] overflow-hidden shadow-xl">
            {[
              ...
              <div
                key={i}
                className="bg-white dark:bg-[#0A0A0A] p-6 md:p-8 flex flex-col items-center justify-center text-center group/stat hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors"
              >
                <stat.icon
                  size={20}
                  className="text-brand-red mb-4 opacity-50 group-hover/stat:opacity-100 group-hover/stat:scale-110 transition-all"
                />
                <span className="text-2xl md:text-3xl font-black tracking-tighter text-black dark:text-white mb-1">
                  {stat.value}
                </span>
      ...
      <section className="relative py-24 px-4 md:px-8 lg:px-12 max-w-[1700px] mx-auto">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-32">
          ...
          <p className="text-xl md:text-2xl text-gray-500 dark:text-gray-400 font-medium leading-relaxed italic">
            "Chaque pixel capturé au Maroc raconte une étape de notre
            accompagnement stratégique pour l'agence Come With Us."
          </p>
        </div>
        ...
        <div className="space-y-48">
          {MASTERPIECES.map((item, idx) => (
            <div
              ...
              } items-center gap-12 lg:gap-24 relative`}
            >
              {/* Numéro flottant */}
              ...
              <div
                className={`w-full ${
                  item.isPortrait ? "lg:w-[35%]" : "lg:w-1/2"
                } relative group`}
              >
                <div
                  className={`relative w-full rounded-[60px] overflow-hidden shadow-2xl border border-black/5 dark:border-white/10 ${
                    item.isPortrait
                      ? "aspect-[3/4]"
                ...
                <div className="absolute top-10 left-10 flex flex-wrap gap-2 opacity-0 group-hover:opacity-100 transition-all duration-700 delay-200">
                  {item.tools.map((t, i) => (
                    <span
                      key={i}
                      className="px-4 py-1.5 rounded-xl bg-black/80 backdrop-blur-xl text-[9px] font-black text-white uppercase tracking-widest border border-white/10"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <div className="flex-1 space-y-10 relative z-10">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <span className="text-xs font-black uppercase tracking-[0.4em] text-gray-500 mb-2 block">
                      {item.location}
                    </span>
                    <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-black dark:text-white leading-[0.9]">
                      {item.title}
                    </h3>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-8 pt-8 border-t border-black/5 dark:border-white/5">
                  <div className="flex flex-col">
                    <span className="text-3xl font-black text-black dark:text-white uppercase tracking-tighter">
                      RAW
                    </span>
        ...
        <div className="relative z-10 container mx-auto flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-16 shadow-lg">
            ...
            <span className="text-[12px] font-black uppercase tracking-[0.5em]">
              L'ARSENAL CRÉATIF GDC
            </span>
          </div>

          <h2 className="text-5xl md:text-8xl lg:text-9xl font-black tracking-tighter uppercase leading-[0.85] mb-20 italic">
            Sculpter <br />{" "}
            <span className="text-brand-red not-italic underline decoration-white/10 underline-offset-[20px]">
              L'Image Digitale.
            </span>
          </h2>
          ...
          <div className="flex flex-col items-center gap-24 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto w-full px-4">
              ...
              <div className="p-12 rounded-[50px] bg-gray-50 dark:bg-white/5 border border-black/5 dark:border-white/5 flex flex-col items-center text-center shadow-lg">
                ...
                <p className="text-2xl md:text-3xl font-serif italic text-gray-600 dark:text-gray-300 leading-tight">
                  "L'innovation est ce qui distingue un leader d'un suiveur. Ne
                  vous arrêtez jamais d'explorer."
                </p>
              </div>
            </div>

            <div className="space-y-12">
              <p className="text-xs md:text-sm font-black uppercase tracking-[0.8em] text-gray-400 dark:text-gray-500">
                Prêt à sublimer votre projet ? Contactez le studio GDC :
              </p>
              <a
                href="mailto:groupdigitalconcept@gmail.com"
                className="group relative inline-flex items-center gap-6 md:gap-10 text-2xl sm:text-3xl md:text-6xl font-black hover:text-brand-red transition-all border-b-8 border-brand-red/20 pb-10"
              >
                <span className="relative z-10 uppercase tracking-tighter">
                  STUDIO_GDC_MARRAKECH
                </span>
                <ArrowRight
                  size={40}
                  className="text-brand-red group-hover:translate-x-10 transition-transform duration-700 md:w-[80px] md:h-[80px]"
                />
              </a>
            </div>
          </div>
