      ...
      <div className="relative z-10 p-8 h-full flex flex-col">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-black dark:text-white font-bold text-base leading-tight">
                {data.name}
              </h4>
              <p className="text-xs text-gray-500 dark:text-gray-500 font-medium uppercase tracking-wide mt-0.5">
                {data.role}
              </p>
            </div>
          </div>
        ...
        <div className="flex gap-1 mb-6">
          {[...Array(5)].map((_, i) => (
            <Star
              ...
              className={`${
                i < data.stars
                  ? "fill-brand-red text-brand-red drop-shadow-[0_0_8px_rgba(220,38,38,0.5)]"
                  : "fill-none text-gray-300 dark:text-gray-800"
              }`}
            />
          ))}
        </div>
    ...
    <section className="relative w-full py-32 bg-[#F0F0F2] dark:bg-[#020202] text-black dark:text-white overflow-hidden border-t border-black/5 dark:border-white/5 transition-colors duration-500">
      ...
      <div className="relative z-10">
          ...
          <h2
            ...
            dangerouslySetInnerHTML={{
              __html: t
                ...
                .replace(
                  /{span}/g,
                  `<span class="text-black dark:text-brand-red dark:drop-shadow-[0_0_30px_rgba(220,38,38,0.3)]">${t(
                    "titleHighlight"
                  )}</span>`
                ),
            }}
        ...
        <div className="container mx-auto px-4 mt-24 flex flex-col items-center justify-center">
          <a
            href="#contact"
            className="group relative px-8 py-4 bg-black dark:bg-white text-white dark:text-black rounded-full font-black uppercase tracking-widest text-xs overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(0,0,0,0.3)] dark:hover:shadow-[0_0_40px_rgba(255,255,255,0.3)]"
          >
