                    ...
                    <div className={`col-span-1 lg:col-span-8 row-span-2 bg-white dark:bg-[#0A0A0A] rounded-[40px] p-8 md:p-12 lg:p-16 border border-black/5 dark:border-white/10 flex flex-col justify-center relative overflow-hidden group shadow-xl ${!isMobile ? 'opacity-0 animate-enter-left' : 'opacity-100'}`}>
                        ...
                        <div className="relative z-10">
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-red/10 border border-brand-red/20 text-brand-red mb-6">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.25em]">{t("hero.badge")}</span>
                            </div>
                            <h1
                                className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-[1.05] mb-8"
                                dangerouslySetInnerHTML={{ __html: t.raw("hero.title").replace(/{br}/g, "<br/>") }}
                            />
                            <div className="space-y-6 text-sm md:text-base text-gray-600 dark:text-gray-400 font-medium leading-relaxed max-w-4xl mb-12 border-l-2 border-brand-red pl-6">
                                <p dangerouslySetInnerHTML={{ __html: t.raw("hero.description") }} />
                            </div>
                            <div className="flex flex-wrap gap-4">
                                <a href="#contact" className={`group px-10 py-5 bg-black dark:bg-white text-white dark:text-black rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-lg flex items-center gap-3 ${!isMobile ? 'hover:scale-105' : 'active:scale-95'}`}>
                                    {t("hero.cta")} <ArrowRight size={18} className={!isMobile ? "group-hover:translate-x-1 transition-transform" : ""} />
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-xs font-black uppercase tracking-[0.2em] text-black dark:text-white">{t("diagnostic.header.title")}</h3>
                                        <p className="text-[8px] font-bold text-gray-500 uppercase tracking-[0.3em] mt-1">{t("diagnostic.header.subtitle")}</p>
                                    </div>
                                </div>
                                {diagStep > 1 && (
                            ...
                            {diagStep === 1 && (
                                <div className="flex-1 flex flex-col animate-fade-in-up">
                                    <h4
                                        ...
                                        dangerouslySetInnerHTML={{ __html: t.raw("diagnostic.step1.title").replace(/{br}/g, "<br/>") }}
                                    />
                                    <div className="grid grid-cols-1 gap-3">
                                        {[
                                            { id: 'vitrine', label: t("diagnostic.step1.options.vitrine.label"), icon: Layout, desc: t("diagnostic.step1.options.vitrine.desc") },
                                            { id: 'ecommerce', label: t("diagnostic.step1.options.ecommerce.label"), icon: ShoppingBag, desc: t("diagnostic.step1.options.ecommerce.desc") },
                                            { id: 'app', label: t("diagnostic.step1.options.app.label"), icon: Smartphone, desc: t("diagnostic.step1.options.app.desc") }
                                        ].map((item) => (
                                            <button
                                                key={item.id}
                            ...
                            {diagStep === 2 && (
                                <div className="flex-1 flex flex-col animate-enter-right">
                                    <h4
                                        className="text-xl font-black uppercase tracking-tighter mb-6 text-black dark:text-white"
                                        dangerouslySetInnerHTML={{ __html: t.raw("diagnostic.step2.title").replace(/{br}/g, "<br/>") }}
                                    />
                                    <div className="grid grid-cols-2 gap-3">
                                        {[
                                            { id: 'sec', label: t("diagnostic.step2.options.sec"), icon: Shield, col: 'text-emerald-500' },
                                            { id: 'perf', label: t("diagnostic.step2.options.perf"), icon: Zap, col: 'text-blue-500' },
                                            { id: 'update', label: t("diagnostic.step2.options.update"), icon: RefreshCw, col: 'text-purple-500' },
                                            { id: 'audit', label: t("diagnostic.step2.options.audit"), icon: Search, col: 'text-orange-500' }
                                        ].map((item) => (
                                            <button
                                                key={item.id}
                                ...
                                <div className="flex-1 flex flex-col animate-enter-zoom">
                                    {isLoading ? (
                                        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
                                            ...
                                            <div>
                                                <p className="text-sm font-black uppercase tracking-widest text-black dark:text-white">{t("diagnostic.step3.loading.title")}</p>
                                                <p className="text-[9px] text-gray-500 uppercase tracking-[0.4em] mt-2">{t("diagnostic.step3.loading.subtitle")}</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <div className="flex-1 flex flex-col">
                                            <div className="mb-6">
                                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 mb-4">
                                                    ...
                                                    <span className="text-[10px] font-black uppercase tracking-widest">{t("diagnostic.step3.success.badge")}</span>
                                                </div>
                                                <h4
                                                    className="text-2xl font-black uppercase tracking-tighter text-black dark:text-white leading-none"
                                                    dangerouslySetInnerHTML={{ __html: t.raw("diagnostic.step3.success.title").replace(/{br}/g, "<br/>") }}
                                                />
                                            </div>
                                            ...
                                            <div className="mt-8 space-y-3">
                                                ...
                                                >
                                                    {t("diagnostic.step3.success.cta")} <ArrowRight size={14} />
                                                </button>
                                                <button onClick={resetDiag} className="w-full py-3 text-[9px] font-black uppercase tracking-[0.4em] text-gray-400 hover:text-black dark:hover:text-white transition-colors">{t("diagnostic.step3.success.restart")}</button>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="mt-auto pt-8 border-t border-black/5 dark:border-white/5 flex items-center justify-center opacity-20">
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <span className="text-[7px] font-black uppercase tracking-[1em]">{t("diagnostic.footer")}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="lg:col-span-5 flex flex-col justify-between">
                                    <div>
                                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-black dark:text-white tracking-tight leading-[1.1] mb-8"
                                            dangerouslySetInnerHTML={{ __html: t.raw("performance.title").replace(/{br}/g, "<br/>") }}
                                        />
                                        <p className="text-xl md:text-2xl font-bold text-black dark:text-white mb-6">{t("performance.subtitle")}</p>
                                        <div className="space-y-8 mb-12">
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <p className="text-sm font-black uppercase tracking-widest text-black dark:text-white">{t("performance.updates.label")}</p>
                                                    <p className="text-xs font-bold text-gray-500 uppercase">{t("performance.updates.sub")}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className={`col-span-1 lg:col-span-12 mt-20 ${!isMobile ? 'opacity-0 animate-enter-bottom delay-800' : 'opacity-100'}`}>
                        <div className="w-full bg-black dark:bg-[#0A0A0A] rounded-[40px] p-12 md:p-20 text-center mb-12 border border-white/5 relative overflow-hidden group">
                            <h2
                                ...
                                dangerouslySetInnerHTML={{ __html: t.raw("atouts.title").replace(/{br}/g, "<br/>") }}
                            />
                        </div>
                    ...
                    <div className={`col-span-1 lg:col-span-12 mt-20 ${!isMobile ? 'opacity-0 animate-enter-bottom delay-900' : 'opacity-100'}`}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
                            <h2
                                ...
                                dangerouslySetInnerHTML={{ __html: t.raw("professional.title").replace(/{br}/g, "<br/>") }}
                            />
                            <p
                                className="text-lg md:text-xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed"
                                dangerouslySetInnerHTML={{ __html: t.raw("professional.intro") }}
                            />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {(t.raw("professional.solutions") as any[]).map((solution, idx) => {
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                            <div className="lg:col-span-7 space-y-10">
                                <h2
                                    ...
                                    dangerouslySetInnerHTML={{ __html: t.raw("mockup.title").replace(/{br}/g, "<br/>") }}
                                />
