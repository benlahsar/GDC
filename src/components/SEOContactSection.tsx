...
import { 
  Send, User, Mail, Globe, MessageSquare, 
  Sparkles, Zap, ShieldCheck, ArrowRight, 
  Loader2, CheckCircle2, TrendingUp, BarChart3
} from 'lucide-react';
...
export const SEOContactSection: React.FC = () => {
  ...
  return (
    <section id="seo-contact" className="relative w-full py-24 md:py-32 bg-transparent overflow-hidden transition-colors duration-500 border-t border-black/5 dark:border-white/5">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1600px] relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
             ...
             <h2 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-black dark:text-white mb-6">
                Prêt pour le <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-red-600">Top 1 ?</span>
             </h2>
             <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                Remplissez le formulaire ci-dessous pour recevoir votre audit SEO gratuit et une stratégie personnalisée.
             </p>
        </div>
            ...
            <div className="lg:col-span-8 bg-white/60 dark:bg-[#0A0A0A]/60 backdrop-blur-2xl border border-black/5 dark:border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
                ...
                {isSuccess ? (
                    <div className="flex flex-col items-center justify-center text-center py-20 animate-enter-zoom h-full">
                        ...
                        <h3 className="text-3xl font-black text-black dark:text-white mb-2">Audit Demandé !</h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-xs mx-auto">
                            Merci {formData.name}. Notre équipe analyse votre site {formData.website} et revient vers vous sous 24h.
                        </p>
                        <button 
                            onClick={() => { setIsSuccess(false); setFormData({name:'', email:'', website:'', details:''}); }}
                    ...
                    <form onSubmit={handleSubmit} className="relative z-10 flex flex-col gap-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1 group-focus-within:text-brand-red transition-colors">Nom Complet</label>
                            ...
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1 group-focus-within:text-brand-red transition-colors">Email Professionnel</label>
                                <div className="relative">
                        ...
                        <div className="space-y-2 group">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1 group-focus-within:text-brand-red transition-colors">URL du Site Web</label>
                            <div className="relative">
                                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-600 group-focus-within:text-brand-red transition-colors" size={18} />
                                <input 
                                    type="url" required
                        ...
                        <div className="space-y-2 group">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1 group-focus-within:text-brand-red transition-colors">Objectifs SEO</label>
                            <div className="relative">
                                <textarea 
                                    required rows={4}
                                    ...
                                    placeholder="Ex: Améliorer mon classement sur 'Hôtel Marrakech', augmenter mon trafic organique..."
                                />
                                <MessageSquare className="absolute bottom-6 right-6 text-gray-400 opacity-30" size={20} />
                            </div>
                        </div>
                        ...
                        <div className="mt-4 pt-6 border-t border-black/5 dark:border-white/5 flex items-center justify-between">
                            <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest max-w-[200px]">
                                <ShieldCheck size={12} className="inline mr-1 text-emerald-500" /> Vos données sont protégées par le RGPD.
                            </p>
                            <button 
                                type="submit" 
                            ...
                            >
                                {isSubmitting ? <Loader2 size={18} className="animate-spin" /> : <>Recevoir mon Audit <Send size={18} /></>}
                            </button>
                        </div>
                    </form>
                )}
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
                ...
                <div className="p-8 rounded-[40px] bg-black dark:bg-white text-white dark:text-black flex flex-col justify-between h-48 shadow-xl group hover:-translate-y-1 transition-all">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-bold uppercase tracking-[0.2em] opacity-60">Croissance Trafic Moyenne</p>
                    </div>
                </div>
                ...
                <div className="p-8 rounded-[40px] bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-black/5 dark:border-white/10 flex flex-col justify-between h-48 shadow-lg group hover:-translate-y-1 transition-all">
                    ...
                    <div>
                        <span className="block text-2xl font-black text-black dark:text-white">Analyse Data</span>
                        <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Décisions stratégiques basées sur des résultats réels.</p>
                    </div>
                </div>
                ...
                <div className="flex-1 p-8 rounded-[40px] bg-brand-red text-white flex flex-col justify-between min-h-[160px] shadow-xl shadow-red-900/20 group hover:scale-[1.02] transition-all relative overflow-hidden">
                    ...
                    <h3 className="text-2xl font-black leading-tight relative z-10">
                        Expertise <br/> Marrakech & <br/> International.
                    </h3>
                    <div className="flex items-center justify-between relative z-10">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-white/80">Support Local</span>
                        <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                            <ArrowRight size={18} className="group-hover:rotate-[-45deg] transition-transform duration-300" />
                        </div>
                    </div>
                </div>
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-8 md:gap-16 opacity-30 grayscale group-hover:grayscale-0 hover:opacity-100 transition-all duration-700">
             <div className="flex items-center gap-2 font-black text-lg tracking-tighter">
                <Globe className="text-brand-red" size={20} /> GOOGLE RANKING
             </div>
             <div className="flex items-center gap-2 font-black text-lg tracking-tighter">
                <ShieldCheck className="text-emerald-500" size={20} /> WHITE HAT SEO
             </div>
             <div className="flex items-center gap-2 font-black text-lg tracking-tighter">
                <Zap className="text-yellow-500" size={20} /> PERFORMANCE ELITE
             </div>
        </div>
