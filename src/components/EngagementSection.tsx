...
export const EngagementSection: React.FC = () => {
    ...
    const styles = [
        { color: "text-purple-500", bg: "bg-purple-500/10", border: "hover:border-purple-500/30", gradient: "via-purple-500" },
        { color: "text-blue-500", bg: "bg-blue-500/10", border: "hover:border-blue-500/30", gradient: "via-blue-500" },
        { color: "text-emerald-500", bg: "bg-emerald-500/10", border: "hover:border-emerald-500/30", gradient: "via-emerald-500" },
        { color: "text-brand-red", bg: "bg-brand-red/10", border: "hover:border-brand-red/30", gradient: "via-red-500" }
    ];
            ...
            <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1600px] relative z-10">
                ...
                <div className="mb-16 md:mb-24 max-w-4xl">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 tracking-tighter leading-[1.1]">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-black to-gray-500 dark:from-white dark:to-gray-500">{t("titleHighlight")}</span>
                    </h2>
                    <p
                        ...
                        dangerouslySetInnerHTML={{
                            __html: t.raw("description").replace("<highlight>", '<span class="text-black dark:text-white font-bold">').replace("</highlight>", '</span>')
                        }}
                    />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
                    ...
                    <div className="lg:col-span-7 row-span-2 group relative p-8 md:p-12 rounded-[40px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 overflow-hidden hover:shadow-2xl hover:border-brand-red/20 transition-all duration-500 flex flex-col">
                        ...
                        <div className="flex items-center gap-5 mb-10 relative z-10">
                            ...
                            <div>
                                <h3 className="text-3xl md:text-4xl font-black text-black dark:text-white leading-none mb-1">{t("support.title")}</h3>
                                <p className="text-sm font-bold uppercase tracking-widest text-gray-500">{t("support.badge")}</p>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        <div className="flex-1 group relative p-8 md:p-10 rounded-[40px] bg-black dark:bg-[#111] text-white overflow-hidden hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
                            ...
                            <div className="relative z-10 h-full flex flex-col">
                                <div className="flex items-center justify-between mb-8">
                                    <h3 className="text-2xl font-black text-white">{t("why.title")}</h3>
                        ...
                        <div className="relative p-8 rounded-[40px] bg-brand-red text-white overflow-hidden shadow-lg shadow-red-600/20 group">
                            ...
                            <div className="relative z-10">
                                <h4 className="text-lg font-black uppercase tracking-wider mb-3 opacity-90 text-white">{t("difference.title")}</h4>
                ...
                <div className="py-12 md:py-20 text-center">
                    <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-6">
                        {t.raw("catchy.title").split("{br}")[0]} <br className="md:hidden" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {(featuresData as any[]).map((item, i) => {
                        ...
                        return (
                            <div key={i} className={`group relative p-8 rounded-[32px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 ${style.border} hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 flex flex-col items-center text-center overflow-hidden`}>
                                <div className={`w-16 h-16 rounded-2xl ${style.bg} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500`}>
                                ...
                                {/* Bottom Bar Reveal */}
                                <div className={`absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent ${style.gradient} to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}></div>
                            </div>
                        );
                    })}
                </div>
