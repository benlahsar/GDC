...
import { Headset, Star, Palette, MousePointer2, Smartphone, Rocket, CheckCircle2, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1600px] relative z-10">
        ...
        <div className="mb-16 md:mb-24 max-w-4xl">
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-red/10 border border-brand-red/20 mb-6 backdrop-blur-md">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-brand-red">Partenariat Premium</span>
             </div>
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 tracking-tighter leading-[1.1]">
                Votre Succès, <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-black to-gray-500 dark:from-white dark:to-gray-500 dark:to-gray-500">Notre Engagement.</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed border-l-2 border-brand-red pl-6">
                Notre accompagnement dépasse la simple livraison de votre projet de <span className="text-black dark:text-white font-bold">création site web Marrakech</span>. Nous devenons l'architecte de votre croissance digitale.
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
            ...
            <div className="
                lg:col-span-7 row-span-2
                group relative p-8 md:p-12 rounded-[40px] 
                bg-white dark:bg-[#0A0A0A] 
                border border-black/5 dark:border-white/10
                overflow-hidden
                hover:shadow-2xl hover:border-brand-red/20 transition-all duration-500
                flex flex-col
            ">
                {/* Background Glow */}
                ...
                <div className="flex items-center gap-5 mb-10 relative z-10">
                    ...
                    <div>
                        <h3 className="text-3xl md:text-4xl font-black text-black dark:text-white leading-none mb-1">Support Continu</h3>
                        <p className="text-sm font-bold uppercase tracking-widest text-gray-500">Disponibilité Totale</p>
                    </div>
                </div>
                
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-6 relative z-10">
                    {[
                        "Assistance technique prioritaire (réponse sous 2h)",
                        "Mises à jour régulières incluses pendant 12 mois",
                        "Conseil stratégique adapté à votre activité",
                        "Formation complète à l'utilisation de votre site",
                        "Rapports mensuels de performance détaillés",
                        ...
                        <div key={i} className="flex gap-3 group/item">
                            <div className="mt-1.5 w-5 h-5 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center shrink-0 group-hover/item:bg-brand-red transition-colors duration-300">
                                <CheckCircle2 size={12} className="text-gray-400 dark:text-gray-500 group-hover/item:text-white transition-colors duration-300" />
                            </div>
                            <span className="text-base font-medium text-gray-600 dark:text-gray-400 group-hover/item:text-black dark:group-hover/item:text-white transition-colors duration-300 leading-snug">{item}</span>
                        </div>
                    ))}
                </div>

                <div className="mt-10 pt-8 border-t border-black/5 dark:border-white/5 relative z-10">
                    <a href="#contact" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-brand-red hover:gap-4 transition-all duration-300">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
                ...
                <div className="
                    flex-1
                    group relative p-8 md:p-10 rounded-[40px] 
                ...
                ">
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="text-2xl font-black text-white">Pourquoi Nous ?</h3>
                            <Star className="text-yellow-400 fill-yellow-400 animate-pulse-slow" />
                        </div>
                        <ul className="space-y-4 flex-1">
                            {[
                                "Partenaire engagé dans votre réussite",
                                "Solutions évolutives avec votre croissance",
                                "Expertise marché local & international",
                                "Résultats mesurables et durables"
                            ].map((item, i) => (
                                <li key={i} className="flex items-start gap-3 text-gray-400 group-hover:text-white transition-colors duration-300">
                ...
                ">
                    ...
                    <div className="relative z-10">
                        <h4 className="text-lg font-black uppercase tracking-wider mb-3 opacity-90 text-white">Notre Différence</h4>
                        <p className="text-white/90 leading-relaxed text-base md:text-lg font-medium">
                            En optant pour notre expertise, vous choisissez un partenaire digital qui comprend vos enjeux locaux et vos ambitions globales.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div className="py-12 md:py-20 text-center">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-6">
                Une Création <br className="md:hidden" />
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium max-w-2xl mx-auto text-lg">
                Nous développons des interfaces qui convertissent les visiteurs en clients fidèles.
            </p>
        </div>
            ...
            {[
                {
                    icon: Palette,
                    title: "Design Unique",
                    desc: "Incarnation fidèle de votre marque avec une identité visuelle distinctive.",
                ...
                },
                {
                    icon: MousePointer2,
                    title: "UX Optimisée",
                    desc: "Parcours client intuitif conçu pour maximiser les conversions.",
                    color: "text-blue-500",
                    bg: "bg-blue-500/10",
                ...
                },
                {
                    icon: Smartphone,
                    title: "100% Mobile",
                    desc: "Affichage parfait sur tous les supports, du smartphone au grand écran.",
                ...
                },
                {
                    icon: Rocket,
                    title: "Performance",
                    desc: "Temps de chargement ultra-rapides pour un référencement optimal.",
                ...
                <div key={i} className={`
                    ...
                    bg-white dark:bg-[#0A0A0A] 
                    border border-black/5 dark:border-white/10 ${item.border}
                ...
                `}>
                    ...
                    {/* Bottom Bar Reveal */}
                    <div className={`absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent ${item.gradient} to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}></div>
                </div>
            ))}
        </div>
