...
export const MaintenanceFinalCTA: React.FC = () => {
  const t = useTranslations("MaintenanceFinalCTA");
          ...
          <div className="relative group p-1.5 rounded-[60px] overflow-hidden transition-all duration-700">
            ...
            <div className="relative bg-white dark:bg-[#080808] rounded-[58px] p-12 md:p-32 text-center border border-black/5 dark:border-white/10 shadow-2xl">
              ...
              <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 mb-10 backdrop-blur-md">
                ...
                <span className="text-xs font-black uppercase tracking-[0.4em] text-black dark:text-white">{t("badge")}</span>
              </div>

              {/* Massive Headline */}
              <h2
                className="text-5xl md:text-8xl lg:text-[10rem] font-black text-black dark:text-white tracking-tighter leading-[0.85] mb-12"
              ...
              <div className={`pt-16 border-t border-black/5 dark:border-white/5 flex flex-wrap justify-center gap-12 md:gap-24 transition-all duration-700 ${!isMobile ? 'opacity-50 grayscale group-hover:grayscale-0 group-hover:opacity-100' : 'opacity-80'}`}>
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <span className="block text-xs font-black uppercase tracking-widest">{t("features.sec_title")}</span>
                    <span className="text-[10px] text-gray-500 uppercase font-bold">{t("features.sec_desc")}</span>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-brand-red/10 rounded-2xl">
                  ...
                  <div className="text-left">
                    <span className="block text-xs font-black uppercase tracking-widest">{t("features.perf_title")}</span>
                    <span className="text-[10px] text-gray-500 uppercase font-bold">{t("features.perf_desc")}</span>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-brand-red/10 rounded-2xl">
                  ...
                  <div className="text-left">
                    <span className="block text-xs font-black uppercase tracking-widest">{t("features.sup_title")}</span>
                    <span className="text-[10px] text-gray-500 uppercase font-bold">{t("features.sup_desc")}</span>
                  </div>
                </div>
              </div>
