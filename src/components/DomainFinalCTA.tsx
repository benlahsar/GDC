  ...
  return (
    <section className="relative w-full py-24 md:py-32 bg-[#F0F0F2] dark:bg-[#050505] overflow-hidden flex flex-col items-center justify-center transition-colors duration-500">
      ...
      <div className="relative w-full max-w-[1200px] h-[700px] md:h-[800px] flex justify-center items-end">
        {/* --- THE FUNNEL (BEAM) --- */}
        <div
          className={`absolute top-0 w-full md:w-[80%] h-[85%] z-10 ${
            isMobile ? "opacity-40" : ""
          }`}
          style={{
        ...
        >
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-b from-[#a855f7] via-[#ec4899] to-[#6366f1] opacity-90 ${
              !isMobile ? "animate-pulse-slow" : "opacity-60"
            }`}
          ></div>
          {!isMobile && (
            <div
        ...
        <div className="absolute top-[10%] md:top-[15%] z-20 flex flex-col items-center text-center px-4 w-full">
          ...
          >
            ...
            <div
              className={`relative w-20 h-20 bg-white/10 backdrop-blur-md rounded-full border border-white/30 flex items-center justify-center shadow-[0_0_30px_rgba(253,224,71,0.6)] ${
                !isMobile
          ...
          <a
            href="#contact"
            className={`group relative px-8 py-4 md:px-10 md:py-5 bg-[#1e1b4b] hover:bg-[#312e81] text-white rounded-full font-black uppercase tracking-widest text-xs md:text-sm shadow-[0_0_40px_rgba(79,70,229,0.6)] hover:shadow-[0_0_60px_rgba(79,70,229,0.8)] ${
          ...
          >
            ...
            <div
              className={`w-6 h-6 rounded-full bg-white/20 flex items-center justify-center relative z-10 ${
                !isMobile
                  ? "group-hover:bg-white group-hover:text-[#1e1b4b]"
                  : ""
              } transition-colors`}
            >
              <ArrowRight
        ...
        <div className="relative z-20 w-[240px] md:w-[320px] h-[140px] md:h-[180px] mb-[-40px] md:mb-[-60px]">
          {/* Cup Body */}
          <div className="w-full h-full bg-gradient-to-b from-cyan-400 to-blue-600 rounded-b-[80px] md:rounded-b-[120px] shadow-[0_0_80px_rgba(34,211,238,0.6)] relative overflow-hidden border-b-4 border-r-4 border-l-4 border-cyan-300/30">
            {/* Liquid Surface */}
