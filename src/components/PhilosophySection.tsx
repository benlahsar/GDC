        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 auto-rows-min">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-8 bg-white dark:bg-[#080808] rounded-[32px] p-8 md:p-12 border border-black/5 dark:border-white/10 flex flex-col justify-center shadow-sm">
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black dark:bg-white text-white dark:text-black w-fit mb-6">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest">Vision & Expertise</span>
             </div>
             <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] mb-6 text-black dark:text-white">
                Vous Rêvez d'un <span className="text-brand-red">Site Web</span> Qui <br/>
             ...
             <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 font-medium max-w-3xl leading-relaxed">
                Une <span className="text-black dark:text-white font-bold">création de site web à Marrakech</span> sur mesure. Nous ne créons pas seulement des sites, nous bâtissons votre avantage concurrentiel.
             </p>
          </div>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-4 bg-[#0A0A0A] dark:bg-white text-white dark:text-black rounded-[32px] p-8 md:p-12 border border-black/5 dark:border-white/10 flex flex-col justify-between shadow-sm">
             ...
             <div>
                ...
                <p className="text-base md:text-lg opacity-80 leading-relaxed font-medium">
                   Votre site est votre identité numérique. Nous allions design sophistiqué et technologie de pointe pour conquérir votre marché.
                </p>
             </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-4 bg-white dark:bg-[#080808] rounded-[32px] p-8 border border-black/5 dark:border-white/10 hover:border-brand-red/30 transition-colors duration-300 shadow-sm">
             <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-lg font-bold uppercase tracking-wide text-black dark:text-white">Notre Approche</h4>
             </div>
             <ul className="space-y-4">
                {["Écoute active des besoins", "Solutions 100% sur mesure", "Processus transparent"].map((item, i) => (
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-4 bg-white dark:bg-[#080808] rounded-[32px] p-8 border border-black/5 dark:border-white/10 hover:border-brand-red/30 transition-colors duration-300 shadow-sm">
             <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-lg font-bold uppercase tracking-wide text-black dark:text-white">Nos Engagements</h4>
             </div>
             <ul className="space-y-4">
                {["Respect strict des délais", "Communication régulière", "Adaptabilité totale"].map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm font-medium text-gray-600 dark:text-gray-400">
                        <div className="w-1.5 h-1.5 rounded-full bg-brand-red mt-1.5 shrink-0"></div>
                        {item}
                    </li>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-4 bg-white dark:bg-[#080808] rounded-[32px] p-8 border border-black/5 dark:border-white/10 hover:border-brand-red/30 transition-colors duration-300 shadow-sm">
             <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-lg font-bold uppercase tracking-wide text-black dark:text-white">Votre Avantage</h4>
             </div>
             <ul className="space-y-4">
                {["Levier de croissance", "Atout concurrentiel durable", "Vitrine digitale d'excellence"].map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm font-medium text-gray-600 dark:text-gray-400">
                        <div className="w-1.5 h-1.5 rounded-full bg-brand-red mt-1.5 shrink-0"></div>
                        {item}
                    </li>
