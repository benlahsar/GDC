  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div
          ref={eyeRef}
          className={`absolute bg-brand-red rounded-full blur-[150px] opacity-[0.08] pointer-events-none ${
            isMobile
              ? "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px]"
              : "top-0 left-0 w-[600px] h-[600px] will-change-transform"
          }`}
        ></div>
      ...
      <div className="relative z-20 container mx-auto px-4 max-w-[1800px] flex flex-col items-center justify-center text-center">
        ...
        >
          {/* Outer Ring */}
          {!isMobile && (
            <div className="absolute inset-0 rounded-full border border-black/20 dark:border-white/20 scale-125 opacity-0 group-hover:opacity-100 group-hover:scale-150 transition-all duration-700 animate-pulse-slow"></div>
          )}
          ...
          <div className="relative w-28 h-28 md:w-40 md:h-40 rounded-full bg-black dark:bg-white text-white dark:text-black flex items-center justify-center transition-all duration-500 ease-out hover:scale-110 shadow-2xl">
            <div className="relative z-10 flex flex-col items-center gap-1 overflow-hidden">
              ...
              {!isMobile && (
                <>
                  <span className="absolute top-full text-xs md:text-sm font-black uppercase tracking-widest group-hover:-translate-y-14 transition-transform duration-300 text-brand-red">
                    Go
                  </span>
