...
export const SeaSmoPage: React.FC = () => {
  const t = useTranslations("sea-smo");
  const [isMobile, setIsMobile] = useState(false);
  const [mousePos, setMousePos] = useState({ x: 0, y: 0 });

  const SERVICE_ICONS: Record<string, { icon: any; color: string }> = {
    community: { icon: MessageSquareHeart, color: "text-pink-500" },
    identity: { icon: Palette, color: "text-purple-500" },
    ads: { icon: MousePointer2, color: "text-blue-500" },
    influencers: { icon: Radio, color: "text-orange-500" },
    content: { icon: PenTool, color: "text-emerald-500" },
    branding: { icon: Fingerprint, color: "text-brand-red" },
  };
  ...
  const FAQ_ITEMS = (t.raw("faq.items") || []) as any[];
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F5] dark:bg-[#000000] text-black dark:text-white transition-colors duration-500 selection:bg-brand-red selection:text-white pb-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-black/5 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md">
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em] text-gray-500 dark:text-gray-300">
                {t("hero.badge")}
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-8 pt-4 items-center">
              <a
                href="#contact-signal"
                className="group relative px-10 py-5 bg-black dark:bg-white text-white dark:text-black rounded-full font-black uppercase tracking-widest text-xs overflow-hidden shadow-2xl hover:scale-105 transition-transform"
              >
              ...
              <div className="flex items-center gap-4 text-xs font-bold text-gray-500 uppercase tracking-wider">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full border-2 border-[#F4F4F5] dark:border-black bg-gray-200 dark:bg-gray-800 overflow-hidden"
                    >
                      <img
          ...
          <div
            className={`order-1 lg:order-2 relative flex items-center justify-center h-[500px] md:h-[600px] ${
              !isMobile ? "opacity-0 animate-enter-right delay-200" : ""
            }`}
          >
            ...
            <div className="relative w-[300px] h-[300px] md:w-[500px] md:h-[500px] animate-float">
              ...
              >
                ...
                <circle
                  ...
                  stroke="currentColor"
                  strokeWidth="1"
                  className="text-black/10 dark:text-white/10 border-dashed"
                  strokeDasharray="4 8"
                />
                <circle
                  cx="250"
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 group">
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 px-3 py-1.5 bg-blue-500/10 border border-blue-500/20 text-blue-500 text-[9px] font-black uppercase tracking-widest rounded-full shadow-lg whitespace-nowrap backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity">
                  Google Ads
                </div>
              </div>
      ...
      <div className="bg-[#F4F4F5] dark:bg-[#000000] py-16 border-y border-black/5 dark:border-white/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-[1700px] relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {[
              { label: t("stats_grid.audience"), value: 300, suffix: "%" },
              { label: t("stats_grid.clients"), value: 98, suffix: "%" },
              { label: t("stats_grid.campaigns"), value: 500, suffix: "+" },
              { label: t("stats_grid.roi"), value: 450, suffix: "%" },
            ].map((stat, i) => (
              <div
                key={i}
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1700px] relative z-10 pt-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center mb-32">
          <div
            className={`${
              !isMobile
                ? "opacity-0 animate-enter-left delay-300"
                : "opacity-100"
            } space-y-10`}
          >
            <div>
            ...
            <div className="space-y-4">
              {[
                { title: t("intro.points.targeting"), icon: Crosshair },
                { title: t("intro.points.retargeting"), icon: Radar },
                { title: t("intro.points.testing"), icon: BarChart2 },
              ].map((pt, i) => (
                <div
                  key={i}
                  className="group flex items-center gap-5 p-4 rounded-2xl border border-black/5 dark:border-white/5 bg-white/50 dark:bg-white/5 hover:border-brand-red/30 transition-all cursor-default"
                >
                  ...
                  <span className="text-sm md:text-base font-bold text-black dark:text-white uppercase tracking-wide">
                    {pt.title}
                  </span>
                </div>
              ))}
          ...
          <div
            className={`relative aspect-square md:aspect-[4/3] rounded-[40px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-2xl overflow-hidden group ${
              !isMobile
                ? "opacity-0 animate-enter-right delay-400"
                : "opacity-100"
            }`}
          >
            ...
            <div className="absolute bottom-10 left-10 right-10 z-20">
              <div className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-black/5 dark:border-white/20 p-6 rounded-3xl flex items-center gap-5 shadow-2xl">
                <div className="w-12 h-12 rounded-full bg-black dark:bg-white flex items-center justify-center shrink-0">
                  <span className="font-black text-white dark:text-black">
                    GDC
                  </span>
                </div>
                <div>
                  <p className="text-black dark:text-white font-bold text-sm leading-tight">
                    "{t("intro.testimonial.quote")}"
                  </p>
                  <p className="text-[9px] font-bold text-gray-500 dark:text-white/50 uppercase tracking-widest mt-1">
                    {t("intro.testimonial.author")}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black text-black dark:text-white uppercase tracking-tighter leading-[0.9]">
              {t.rich("smashy.title", {
                gold: (chunks: any) => (
                  <span className="text-[#D4AF37]">{chunks}</span>
                ),
                br: () => <br />,
              })}
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
              {t("smashy.description")}
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        ref={servicesRef}
        className={`relative mt-20 py-24 mx-4 md:mx-8 rounded-[60px] bg-white/30 dark:bg-black/40 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-2xl overflow-hidden transition-all duration-700 ${
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-[1800px] relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {serviceKeys.map((key, index) => {
              const Icon = SERVICE_ICONS[key].icon;
              const iconColor = SERVICE_ICONS[key].color;
              return (
                <div
                  key={index}
                  className="group relative p-8 md:p-10 rounded-[32px] bg-white dark:bg-[#111] border border-black/5 dark:border-white/10 hover:border-brand-red/30 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col justify-between h-full"
                >
                  <div className="mb-6 flex justify-between items-start">
                    <div
                      className={`w-14 h-14 rounded-2xl bg-gray-50 dark:bg-white/5 flex items-center justify-center ${iconColor} group-hover:scale-110 transition-transform duration-500`}
                    >
                      <Icon size={28} strokeWidth={1.5} />
                    </div>
                  </div>
                  <div>
                    <h3 className="text-xl font-black text-black dark:text-white uppercase tracking-tight mb-2 leading-tight">
                      {t(`services.items.${key}.title`)}
                    </h3>
                    <p
                      className={`text-xs font-bold uppercase tracking-widest mb-6 ${iconColor}`}
                    >
                      {t(`services.items.${key}.subtitle`)}
                    </p>
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                      {t.rich(`services.items.${key}.desc`, {
                        strong: (chunks: any) => (
      ...
      <section
        className={`relative mt-32 py-24 px-4 md:px-12 lg:px-24 mx-4 md:mx-8 rounded-[40px] md:rounded-[60px] bg-[#F4F4F5] dark:bg-[#000000] text-black dark:text-white overflow-hidden border border-black/5 dark:border-white/5 transition-all duration-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
        }`}
      >
        <div className="max-w-[1800px] mx-auto relative z-10">
          <div className="mb-20 text-center">
            <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.85] mb-6 text-black dark:text-white">
              {t.rich("faq.title", {
                red: (chunks: any) => (
              ...
              <button
                ...
                className={`group relative w-full text-left p-6 rounded-2xl border transition-all duration-500 overflow-hidden ${
                  activeFaqIndex === index
                    ...
                    : "bg-white/40 dark:bg-white/5 text-gray-600 dark:text-gray-500 border-black/5 dark:border-white/5 hover:bg-white/60 dark:hover:bg-white/10"
                }`}
              >
            ...
            <div className="relative h-full min-h-[400px] rounded-[40px] bg-white dark:bg-[#0E0E0E] border border-black/5 dark:border-white/10 p-8 md:p-16 flex flex-col justify-center overflow-hidden shadow-2xl">
              <div className="relative z-10">
                <div className="text-xl md:text-3xl font-medium leading-relaxed text-gray-700 dark:text-gray-300 min-h-[120px] mb-12 font-mono">
                  <SmoothScrambleText
                    text={FAQ_ITEMS?.[activeFaqIndex]?.answer || ""}
                    isActive={true}
                  />
                </div>
                <div className="flex flex-wrap gap-3">
                  {FAQ_ITEMS?.[activeFaqIndex]?.tags?.map(
                    (tag: string, i: number) => (
                      <div
                        key={i}
                        className="px-4 py-2 rounded-lg bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 flex items-center gap-2"
                      >
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 mb-24 items-start">
          <div className={`lg:w-1/2 ${!isMobile ? "animate-enter-left" : ""}`}>
            ...
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.85] text-black dark:text-white uppercase mb-8">
              {t.rich("strategy.title", {
                italic: (chunks: any) => (
                  <span className="text-brand-red italic underline decoration-black/5 dark:decoration-white/5 underline-offset-[20px]">
                    {chunks}
                  </span>
                ),
                br: () => <br />,
          ...
          <div
            className={`lg:w-1/2 space-y-10 lg:pt-20 ${
          ...
          >
            ...
            <div className="flex items-center gap-6">
              <button
                onClick={() =>
                  document
                    .getElementById("contact-signal")
                    ?.scrollIntoView({ behavior: "smooth" })
                }
                className="px-10 py-5 bg-black dark:bg-white text-white dark:text-black rounded-full font-black uppercase tracking-widest text-[11px] shadow-2xl hover:scale-105 transition-all flex items-center gap-4 group/btn"
              >
                {t("strategy.cta")}{" "}
                <ArrowRight
                  size={18}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
          <div className="lg:col-span-4 bg-white dark:bg-[#0A0A0A] rounded-[48px] p-10 border border-black/5 dark:border-white/10 shadow-xl group hover:border-brand-red/30 transition-all duration-500 overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h4 className="text-2xl font-black text-black dark:text-white uppercase tracking-tight mb-4">
                {t("strategy.sea.title")}
              </h4>
          ...
          <div className="lg:col-span-4 bg-white dark:bg-[#0A0A0A] rounded-[48px] p-10 border border-black/5 dark:border-white/10 shadow-xl group hover:border-brand-red/30 transition-all duration-500 overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h4 className="text-2xl font-black text-black dark:text-white uppercase tracking-tight mb-4">
                {t("strategy.email.title")}
              </h4>
              <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed mb-10 flex-1">
                {t("strategy.email.desc")}
              </p>
              <div className="flex items-center justify-between pt-6 border-t border-black/5 dark:border-white/5 opacity-40 group-hover:opacity-100 transition-opacity">
                <span className="text-[10px] font-black uppercase tracking-widest">
                  {t("strategy.email.badge")}
                </span>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="max-w-xl text-center md:text-left">
                <h3 className="text-4xl md:text-5xl font-black text-black dark:text-white uppercase tracking-tighter leading-none mb-6">
                  {t.rich("strategy.ecosystem.title", {
                    red: (chunks: any) => (
                      <span className="text-brand-red">{chunks}</span>
                    ),
                  })}
              ...
              <div className="relative w-64 h-64 flex items-center justify-center group/globe">
                ...
                <Globe
                  size={180}
                  strokeWidth={1}
                  className="text-brand-red opacity-10 group-hover/globe:opacity-20 transition-opacity duration-1000 animate-[spin_20s_linear_infinite]"
                />
      ...
      <section className="relative py-24 md:py-40 px-4 md:px-8 lg:px-12 max-w-[1700px] mx-auto z-10 border-t border-black/5 dark:border-white/5">
        <div className="text-center mb-24 md:mb-36">
          <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full border border-black/5 dark:border-white/10 bg-white/40 dark:bg-white/5 backdrop-blur-md mb-10 shadow-sm">
            ...
            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-800 dark:text-white/80">
          ...
          <h2 className="text-5xl md:text-7xl lg:text-[7rem] font-black text-black dark:text-white tracking-tighter leading-[0.8] uppercase italic">
            {t.rich("testimonials.title", {
              red: (chunks: any) => (
                <span className="text-brand-red not-italic drop-shadow-[0_10px_40px_rgba(255,0,0,0.2)]">
                  {chunks}
                </span>
              ),
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          <div className="lg:col-span-8 bg-white dark:bg-[#080808] rounded-[60px] p-10 md:p-20 border border-black/5 dark:border-white/10 shadow-2xl relative overflow-hidden group hover:border-brand-red/40 transition-all duration-700">
            <div className="absolute top-0 right-0 p-12 text-black/[0.02] dark:text-white/[0.02] font-black text-[15rem] leading-none pointer-events-none select-none group-hover:text-brand-red/[0.04] transition-colors duration-700">
              65
            </div>

            <div className="relative z-10 flex flex-col h-full">
              <div className="flex items-center gap-6 mb-16">
                <div className="w-16 h-16 rounded-[2rem] bg-black dark:bg-white flex items-center justify-center text-white dark:text-black font-black text-2xl shadow-2xl group-hover:rotate-12 transition-transform duration-500">
                  R
                </div>
                <div>
                  <h4 className="text-3xl font-black text-black dark:text-white tracking-tighter uppercase leading-none">
                    {t("testimonials.riad.title")}
                  </h4>
                  <p className="text-[10px] font-bold text-brand-red uppercase tracking-[0.4em] mt-2">
                    {t("testimonials.riad.subtitle")}
                  </p>
                </div>
              </div>
              ...
              <div className="relative mb-20 max-w-3xl">
                ...
                <p className="text-2xl md:text-4xl lg:text-[2.8rem] text-black dark:text-white font-black leading-[1.05] tracking-tight relative z-10 italic">
                  "
                  {t.rich("testimonials.riad.quote", {
                    red: (chunks: any) => (
                      <span className="text-brand-red">{chunks}</span>
                    ),
                  })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16 border-t border-black/5 dark:border-white/5">
                <div className="space-y-2 group/metric">
                  <p className="text-[9px] font-black text-gray-500 uppercase tracking-[0.3em]">
                    {t("testimonials.riad.roi")}
                  </p>
                  <div className="flex items-baseline gap-1">
                    <span className="text-4xl font-black text-black dark:text-white tracking-tighter group-hover/metric:text-brand-red transition-colors">
                      +65%
                    </span>
                  </div>
                </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            <div className="flex-1 bg-black text-white rounded-[60px] p-12 border border-white/5 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col justify-between h-full">
                ...
                <div>
                  <h3 className="text-4xl font-black uppercase tracking-tighter leading-[0.9] mb-6">
                    {t.rich("testimonials.performance.title", {
                      br: () => <br />,
                    })}
                  </h3>
                  <p className="text-sm text-gray-400 font-bold leading-relaxed tracking-wide">
                    {t.rich("testimonials.performance.desc", {
                      white: (chunks: any) => (
                ...
                <div className="mt-12 pt-10 border-t border-white/10">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-black text-gray-500 uppercase tracking-[0.4em] mt-2">
                      {t("testimonials.performance.rate")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] mb-1">
                    {t("testimonials.security.subtitle")}
                  </p>
                  <p className="text-lg font-black text-black dark:text-white tracking-tight leading-none uppercase">
                    {t("testimonials.security.title")}
                  </p>
                </div>
              </div>
            </div>
