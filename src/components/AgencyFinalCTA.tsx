...
export const AgencyFinalCTA: React.FC<{ isMobile?: boolean }> = ({ isMobile }) => {
  return (
    <section className="relative w-full pt-32 md:pt-48 pb-0 overflow-hidden bg-white dark:bg-[#020202] transition-colors duration-1000">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none">
            {/* Ambient Red Core */}
            <div className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-brand-red/[0.04] rounded-full blur-[120px] transition-opacity duration-1000 ${!isMobile ? 'animate-pulse' : ''}`}></div>
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 max-w-[1800px] text-center">
            ...
            <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full border border-black/5 dark:border-white/10 bg-white/40 dark:bg-white/5 backdrop-blur-md mb-12 shadow-sm">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-gray-800 dark:text-gray-200">INITIER LE CHANGEMENT</span>
            </div>
            ...
            <div className="relative mb-20 md:mb-32">
                <h2 className="text-5xl md:text-8xl lg:text-[10rem] xl:text-[13rem] font-black text-black dark:text-white tracking-tighter leading-[0.8] uppercase flex flex-col items-center">
                    <span className="block opacity-20 dark:opacity-10 select-none">Votre Vision.</span>
                    <span className="block text-brand-red italic -mt-2 md:-mt-6 lg:-mt-10">L'Excellence.</span>
                </h2>
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex justify-between items-center pointer-events-none opacity-20 hidden lg:flex px-12">
                   <span className="text-[10px] font-black uppercase tracking-[1em] rotate-90">PROTOCOL GDC-V4</span>
                   <span className="text-[10px] font-black uppercase tracking-[1em] -rotate-90">ELITE STANDARD</span>
                </div>
            </div>

            <p className="text-xl md:text-3xl text-gray-600 dark:text-gray-400 mb-20 max-w-4xl mx-auto font-light leading-relaxed">
                Ne laissez pas votre projet être une simple ébauche digitale. <br className="hidden md:block" />
                Collaborons pour sculpter votre <span className="text-black dark:text-white font-black">Suprématie Numérique.</span>
            </p>
                ...
                >
                    ...
                    <div className="relative bg-white dark:bg-black px-12 py-7 md:px-20 md:py-10 rounded-full flex items-center gap-8 md:gap-12 transition-colors group-hover:bg-gray-50 dark:group-hover:bg-[#050505]">
                        <div className="text-left">
                            ...
                            <span className="text-lg md:text-2xl font-black uppercase tracking-widest text-black dark:text-white">DÉPLOYER MON PROJET</span>
                        </div>
