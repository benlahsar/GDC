...
export const HeroBento: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-screen pt-48 md:pt-48 lg:pt-52 pb-10 flex flex-col justify-center overflow-hidden bg-white dark:bg-black transition-colors duration-500">
              ...
              >
                ...
                >
                  <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-widest">
                    <Zap size={12} fill="currentColor" /> {tInnovation("tag")}
                  </div>
