  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className={`absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-brand-red/[0.08] rounded-full blur-[120px] ${
            !isMobile
        ...
        ></div>
        <div
          className={`absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-blue-600/[0.05] rounded-full blur-[150px] ${
            !isMobile
              ? "transition-transform duration-100 ease-out will-change-transform"
              : "opacity-40"
          }`}
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1800px] relative z-10 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 auto-rows-[minmax(180px,auto)] mb-12">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h1
                className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tighter leading-[1.1] mb-6 text-black dark:text-white"
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="#contact"
                  className="group px-8 py-4 bg-black dark:bg-white text-white dark:text-black rounded-2xl font-bold uppercase tracking-widest text-xs hover:scale-105 transition-all shadow-lg flex items-center gap-2"
                >
                  {t("cta")}{" "}
                  <ArrowRight
                    size={16}
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8 z-20 flex flex-col gap-4">
              <div
                className={`flex items-center justify-between p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg ${
                  !isMobile
          ...
          {/* 3. FEATURE: SEO & PERF */}
          <div
            className={`col-span-1 md:col-span-1 lg:col-span-4 bg-[#F5F5F7] dark:bg-[#0A0A0A] rounded-[40px] p-8 border border-black/5 dark:border-white/10 flex flex-col justify-between group transition-all duration-300 ${
              !isMobile
                ? "opacity-0 animate-fade-in-up delay-200 hover:-translate-y-2"
                : "opacity-100"
            }`}
          >
          ...
          <div
            className={`col-span-1 md:col-span-1 lg:col-span-4 bg-[#F5F5F7] dark:bg-[#0A0A0A] rounded-[40px] p-8 border border-black/5 dark:border-white/10 flex flex-col justify-between group transition-all duration-300 ${
              !isMobile
                ? "opacity-0 animate-fade-in-up delay-300 hover:-translate-y-2"
                : "opacity-100"
            }`}
          >
          ...
          {/* 5. FEATURE: SECURITY */}
          <div
            className={`col-span-1 md:col-span-2 lg:col-span-4 bg-[#F5F5F7] dark:bg-[#0A0A0A] rounded-[40px] p-8 border border-black/5 dark:border-white/10 flex flex-col justify-between group transition-all duration-300 ${
              !isMobile
                ? "opacity-0 animate-fade-in-up delay-400 hover:-translate-y-2"
                : "opacity-100"
            }`}
          >
        ...
        {/* --- STATS STRIP --- */}
        <div
          className={`bg-black dark:bg-white text-white dark:text-black rounded-[30px] p-8 md:p-12 mb-20 ${
            !isMobile ? "animate-enter-bottom" : ""
          }`}
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/20 dark:divide-black/10">
            <div className="flex flex-col items-center justify-center pt-4 md:pt-0">
              ...
              <span className="text-sm uppercase tracking-widest opacity-70 mt-2 font-bold">
                {t("stats.projects")}
              </span>
            </div>
            <div className="flex flex-col items-center justify-center pt-8 md:pt-0">
              <div className="flex items-baseline gap-1">
                <AnimatedCounter
                  value={94}
                  suffix="%"
                  className="text-5xl md:text-6xl font-black text-brand-red"
                />
              </div>
              <span className="text-sm uppercase tracking-widest opacity-70 mt-2 font-bold">
        ...
        <div
          className={`grid grid-cols-2 md:grid-cols-5 gap-4 mb-24 ${
            !isMobile ? "opacity-0 animate-fade-in-up delay-500" : ""
          }`}
        >
          {[
            { icon: Search, label: t("features.seo.title") },
            { icon: PenTool, label: t("features.design.title") },
            { icon: Lock, label: t("features.security.title") },
            { icon: Headset, label: t("features.support.label") },
            { icon: CheckCircle, label: t("features.results.label") },
          ].map((feat, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center text-center gap-3 p-4 rounded-2xl bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/5 hover:border-brand-red/30 transition-all group"
            >
              <feat.icon className="text-gray-400 group-hover:text-brand-red transition-colors w-6 h-6" />
              <span className="text-[10px] md:text-xs font-bold uppercase text-gray-600 dark:text-gray-300 group-hover:text-black dark:group-hover:text-white transition-colors">
                {feat.label}
              </span>
            </div>
          ))}
        ...
        <div className="py-16 md:py-24 border-t border-black/5 dark:border-white/5">
          <div className="text-center mb-16">
            <h2
              ...
              dangerouslySetInnerHTML={{ __html: t.raw("technologies.title") }}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: t("technologies.platforms.custom.desc"),
                features: t.raw(
                  "technologies.platforms.custom.features"
                ) as string[],
                icon: Globe,
              },
            ].map((platform, idx) => (
              <div
                key={idx}
                className={`bg-white dark:bg-[#080808] p-8 rounded-[30px] border border-black/5 dark:border-white/5 transition-all duration-300 group ${
                  !isMobile ? "hover:border-brand-red/30 hover:shadow-2xl" : ""
                }`}
              >
                <div
                  className={`w-16 h-16 rounded-full bg-gray-50 dark:bg-white/5 flex items-center justify-center mb-6 ${
                    !isMobile
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm leading-relaxed min-h-[60px]">
                  {platform.desc}
                </p>
                <ul className="space-y-3">
                  {platform.features.map((feat, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-2 text-sm font-bold text-black dark:text-white"
                    >
