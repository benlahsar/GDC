...
export const EcommerceContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative w-full py-24 md:py-32 bg-[#F0F0F2] dark:bg-[#050505] text-black dark:text-white overflow-hidden transition-colors duration-500 border-t border-black/5 dark:border-white/5">
      
      {/* Background Ambience */}
      <div className="absolute inset-0 pointer-events-none">
        <div className={`absolute top-0 right-0 w-[800px] h-[800px] bg-brand-red/[0.03] rounded-full blur-[150px] -translate-y-1/2 translate-x-1/3 ${isMobile ? 'opacity-20' : ''}`}></div>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1600px] relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className={`relative ${!isMobile ? 'animate-enter-right delay-200' : ''}`}>
            ...
            <div className="
                relative bg-white/80 dark:bg-[#0A0A0A]/90 backdrop-blur-xl
            ...
            ">
              ...
              <div className="flex items-center justify-between mb-12 relative px-4">
                 ...
                 {[
                   ...
                   return (
                     <div key={s.id} className="relative z-10 flex flex-col items-center gap-3 bg-transparent px-2">
                        <div className={`
              ...
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
                  <div className="flex-1 relative overflow-hidden">
                    ...
                    {/* STEP 1 */}
                    <div className={`transition-all duration-500 ease-in-out flex flex-col gap-5 ${step === 1 ? 'opacity-100 translate-x-0 z-10' : 'opacity-0 -translate-x-full absolute inset-0 pointer-events-none'}`}>
                           ...
                           {SERVICES.map((srv) => {
                             ...
                             return (
                               <div 
                                 ...
                                 `}
                               >
                                 <srv.icon size={24} className={isSelected ? 'text-white' : ''} />
                                 <span className={`text-xs font-bold uppercase tracking-wider ${isSelected ? 'text-white' : ''}`}>{srv.label}</span>
                               </div>
                             )
                           })}
                        </div>
