...
export const SEOExcellenceSection: React.FC = () => {
  ...
  const BENTO_ITEMS = [
    {
      title: t("excellence.items.vitrine.title"),
      desc: t("excellence.items.vitrine.description"),
      icon: Monitor,
      size: "lg:col-span-4",
      color: "text-blue-500",
      bg: "bg-blue-500/10",
      badge: t("excellence.items.vitrine.badge"),
      image:
        "https://images.unsplash.com/photo-1497215728101-856f4ea42174?q=80&w=2670&auto=format&fit=crop",
    },
    {
      title: t("excellence.items.ecommerce.title"),
      desc: t("excellence.items.ecommerce.description"),
      icon: ShoppingBag,
      size: "lg:col-span-8",
      color: "text-brand-red",
      bg: "bg-brand-red/10",
      badge: t("excellence.items.ecommerce.badge"),
      image:
        "https://group-digitalconcept.com/wp-content/uploads/2025/12/Design-sans-titre-83.png",
    },
    {
      title: t("excellence.items.institution.title"),
      desc: t("excellence.items.institution.description"),
      icon: Landmark,
      size: "lg:col-span-7",
      color: "text-yellow-500",
      bg: "bg-yellow-500/10",
      badge: t("excellence.items.institution.badge"),
      image:
        "https://group-digitalconcept.com/wp-content/uploads/2025/12/Design-sans-titre-84.png",
    },
    {
      title: t("excellence.items.app.title"),
      desc: t("excellence.items.app.description"),
      icon: Smartphone,
      size: "lg:col-span-5",
      color: "text-emerald-500",
      bg: "bg-emerald-500/10",
      badge: t("excellence.items.app.badge"),
      image:
  ...
  return (
    <section className="relative w-full py-24 md:py-32 bg-transparent overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className={`absolute top-1/2 left-0 w-[600px] h-[600px] bg-brand-red/[0.03] rounded-full blur-[120px] -translate-y-1/2 ${
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-end mb-16 md:mb-24">
          <div className="flex-1">
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-[0.9] text-black dark:text-white uppercase">
              {t.rich("excellence.title", {
                solutions: (chunks) => (
                  <>
                    <br />
                    <span className="text-gray-400 dark:text-gray-500 transition-all duration-700 hover:text-black dark:hover:text-white">
                      {chunks}
                    </span>
                  </>
                ),
                excellence: (chunks) => (
                  <>
                    <br />
                    <span className="text-brand-red relative">{chunks}</span>
                  </>
                ),
              })}
            </h2>
            ...
            >
              ...
              {item.image && (
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[40px]">
                  <img
                    src={item.image}
                    alt={item.title}
                    className={`w-full h-full object-cover opacity-30 dark:opacity-40 transition-transform duration-1000 ${
              ...
              <div className="relative z-10 p-8 md:p-12 flex flex-col h-full">
                <div className="flex justify-between items-start mb-auto">
                  <div
                    className={`w-14 h-14 rounded-2xl ${
                      item.bg
                    } flex items-center justify-center transition-all duration-500 border border-white/10 shadow-inner ${
                      !isMobile ? "group-hover:scale-110" : ""
                    }`}
                  >
                    <item.icon
                  ...
                  <span className="px-3 py-1 rounded-full bg-white/40 dark:bg-black/40 backdrop-blur-md border border-black/5 dark:border-white/10 text-[9px] font-black uppercase tracking-widest text-gray-800 dark:text-gray-200">
                    {item.badge}
                  </span>
                </div>
                ...
                <div className="mt-8 bg-white/10 dark:bg-black/10 backdrop-blur-sm rounded-3xl p-6 border border-white/10">
                  <h3
                    className={`text-2xl md:text-3xl font-black text-black dark:text-white mb-4 transition-colors ${
                ...
                <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5 flex items-center justify-between group/btn cursor-pointer">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-gray-500">
                      {t("excellence.items.label")}
                    </span>
                  </div>
                  <div
                    className={`w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 flex items-center justify-center transition-all duration-300 shadow-sm ${
                      !isMobile
                        ? "group-hover/btn:bg-brand-red group-hover/btn:text-white"
                        : ""
                    }`}
                  >
                    <ArrowUpRight
                      ...
                      className={`transform transition-transform ${
                        !isMobile ? "group-hover/btn:rotate-45" : ""
                      }`}
                    />
                  </div>
                </div>
            ...
            <div className="relative z-10 flex flex-wrap gap-4 justify-center md:justify-end shrink-0">
              <div className="px-6 py-4 rounded-2xl bg-white/10 dark:bg-black/5 border border-white/10 dark:border-black/10 backdrop-blur-md flex flex-col items-center">
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest opacity-60">
                  {t("excellence.banner.ranking")}
                </span>
              </div>
              <div className="px-6 py-4 rounded-2xl bg-white/10 dark:bg-black/5 border border-white/10 dark:border-black/10 backdrop-blur-md flex flex-col items-center">
                <span className="text-2xl font-black">99.9%</span>
                <span className="text-[9px] font-bold uppercase tracking-widest opacity-60">
                  {t("excellence.banner.success")}
                </span>
              </div>
              <a
                href="#contact"
                className={`px-10 py-5 bg-brand-red text-white rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-xl shadow-red-600/30 flex items-center gap-3 self-center ${
                  !isMobile ? "hover:scale-105" : ""
                }`}
              >
                {t("excellence.banner.cta")} <Sparkles size={16} />
              </a>
            </div>
          </div>
        </div>
