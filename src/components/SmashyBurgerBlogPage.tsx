...
import { 
  Sparkles, Palette, Zap, ArrowRight, 
  Target, Fingerprint, Activity, 
  ArrowUpRight, ShieldCheck, MousePointer2,
  Layers, Smartphone, Code2, Monitor, 
  MoveDown, Star, X, Info, Shield, 
  Eye, Cpu, Type
} from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-full bg-black dark:bg-white rounded-full border-4 border-[#D4AF37] flex flex-col items-center justify-center shadow-2xl group-hover:shadow-[#D4AF37]/50 transition-all overflow-hidden">
                <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-[#D4AF37] mb-1">PRESS TO</span>
                <span className="text-2xl md:text-4xl font-black text-white dark:text-black uppercase tracking-tighter">SMASH</span>
...
export const SmashyBurgerBlogPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-[#FDFDFD] dark:bg-[#020202] text-black dark:text-white transition-all duration-1000 relative overflow-x-hidden ${smashActive ? 'animate-shake' : ''}`}>
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-4 md:px-12 lg:px-24 pt-32 pb-32 z-10">
        <div className="max-w-[1920px] mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                
                <div className="lg:col-span-8">
                    <div className={`inline-flex items-center gap-4 px-6 py-2.5 rounded-full bg-white/50 dark:bg-white/5 backdrop-blur-3xl border border-black/5 dark:border-white/10 mb-12 shadow-sm transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="w-2 h-2 rounded-full bg-brand-red animate-pulse"></div>
                        <span className="text-[10px] font-black uppercase tracking-[0.6em] text-gray-800 dark:text-gray-200">CASE STUDY • GDC_IDENTITY_V4</span>
                    </div>
                    
                    <div className="relative group cursor-default">
                      <h1 className={`text-7xl md:text-9xl lg:text-[14rem] font-black tracking-tighter leading-[0.75] uppercase mb-16 transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
                          SMASHY <br/>
                          <span 
                            ...
                            style={{ textShadow: smashActive ? '0 0 100px rgba(212,175,55,0.8)' : 'none' }}
                          >BGs.</span>
                      </h1>
                      {/* Secondary Outline text for depth */}
                      <span className="absolute -top-4 -left-4 text-black/[0.02] dark:text-white/[0.02] text-9xl md:text-[20rem] font-black pointer-events-none select-none uppercase tracking-tighter">PRESTIGE</span>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 mt-12">
                        ...
                        <div className="max-w-md space-y-6">
                            ...
                            <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest leading-relaxed">
                                GDC a architecturé une identité de marque monumentale, brisant les codes de la restauration rapide pour le marché du luxe à Marrakech.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 relative hidden lg:block">
                     <div className="space-y-6">
                        {[
                            ...
                            { label: "UX FRICTION", val: "0.01", sub: "Score de fluidité" },
                            { label: "VISUAL IMPACT", val: "HIGH", sub: "Niveau rétinien" }
                        ].map((stat, i) => (
                            <div 
                              key={i} 
                              className={`p-8 rounded-[40px] bg-white/40 dark:bg-white/[0.02] backdrop-blur-3xl border border-white/40 dark:border-white/10 transition-all duration-1000 hover:scale-105 hover:border-[#D4AF37]/50 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`} 
                              style={{ animationDelay: `${i * 200 + 600}ms` }}
                            >
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#D4AF37] mb-2 block">{stat.label}</span>
                                <div className="flex items-baseline justify-between">
                                  <span className="text-5xl font-black tracking-tighter">{stat.val}</span>
                                  <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest">{stat.sub}</span>
                                </div>
                            </div>
                        ))}
                     </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                  <div className="lg:col-span-4 space-y-8">
                      ...
                      <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none">
                          Branding <br/> <span className="text-[#D4AF37] italic">Moléculaire.</span>
                      </h2>
                      <p className="text-lg text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                          La marque n'est pas un bloc statique, c'est un ensemble d'atomes en interaction. Manipulez les éléments fondamentaux de l'identité Smashy BGs.
                      </p>
                      <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] text-gray-500">
                          <MousePointer2 size={16} className="text-[#D4AF37] animate-bounce" />
                  ...
                  <div className="lg:col-span-8">
                      ...
                      >
                          ...
                          <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.05] group-hover/sandbox:opacity-[0.1] transition-opacity duration-1000">
                              <img src="https://groupdigitalconcept.com/wp-content/uploads/2024/04/Design-sans-titre-23.png" className="w-[60%] max-w-[400px] grayscale brightness-0 dark:invert" alt="watermark" />
                          </div>
                          ...
                          <div className="absolute bottom-10 left-10 p-6 rounded-3xl bg-black/80 backdrop-blur-xl border border-white/10 text-white shadow-2xl">
                              <div className="flex items-center gap-4">
                                  ...
                                  <span className="text-[10px] font-black uppercase tracking-widest">Physics Core v.4.2</span>
                              </div>
                          </div>
                      </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative aspect-square bg-[#0A0A0A] rounded-[60px] p-12 border border-white/10 flex flex-col items-center justify-center overflow-hidden">
                             ...
                             <div className="absolute inset-0 flex items-center justify-center">
                                <img src="https://groupdigitalconcept.com/wp-content/uploads/2025/12/Generated-Image-December-22-2025-10_44AM.jpeg" className="w-56 h-56 object-contain drop-shadow-[0_0_50px_rgba(212,175,55,0.4)] transition-transform duration-700 group-hover:scale-110" alt="logo construct" />
                             </div>

                             <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black text-[#D4AF37] uppercase tracking-widest">Construct Module v1</span>
                                    <span className="text-xs font-mono text-white/40">Math: Golden Ratio (φ)</span>
                                </div>
                ...
                <div className="lg:col-span-7 order-1 lg:order-2 space-y-12">
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.3em]">Architectural Grid</span>
                    </div>
                    <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-none">
                        L'Ingénierie du <br/> <span className="text-brand-red">Sacré.</span>
                    </h2>
                    <p className="text-xl md:text-2xl text-gray-500 dark:text-gray-400 font-medium leading-relaxed max-w-2xl">
                        Chaque courbe du logotype Smashy BGs a été calculée selon le nombre d'or. Nous avons créé une grammaire visuelle mathématique pour assurer une harmonie parfaite sur tous les supports.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="p-8 rounded-[40px] bg-gray-50 dark:bg-white/5 border border-black/5 dark:border-white/5 transition-all hover:border-[#D4AF37]/50">
                            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Géométrie Variable</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400 font-bold leading-relaxed">Une structure adaptive qui conserve sa lisibilité sur un favicon comme sur un panneau géant.</p>
                        </div>
                        <div className="p-8 rounded-[40px] bg-gray-50 dark:bg-white/5 border border-black/5 dark:border-white/5 transition-all hover:border-brand-red/50">
                            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-brand-red mb-4">Sémantique Visuelle</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400 font-bold leading-relaxed">Fusionner la brutalité du "Smash" avec la finesse et l'élégance du luxe marrakchi.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
                <div className="lg:col-span-5 space-y-12">
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">Genetic Synthesis</span>
                    </div>
                    <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.8]">
                        Synthèse <br/> <span className="italic text-[#D4AF37]">Chromatique.</span>
                    </h2>
                    <p className="text-xl text-gray-400 font-medium leading-relaxed">
                        Chaque teinte a été sélectionnée pour déclencher une réaction neurologique spécifique liée au désir culinaire et à la perception du luxe.
                    </p>
                    <div className="flex items-center gap-6 p-8 rounded-[40px] bg-white/5 border border-white/5">
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-black font-black text-xl shadow-xl transition-colors duration-500" style={{ backgroundColor: activeColor }}>
                            {activeColor === "#D4AF37" ? "98%" : "85%"}
                        </div>
                        <p className="text-sm font-bold text-gray-400 uppercase tracking-widest">Impact sur la mémorisation visuelle de l'audience cible.</p>
                    </div>
                </div>

                <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-8">
                    {[
                        { color: "#D4AF37", name: "Imperial Gold", sub: "Authority & Success", desc: "La couleur de l'ancrage. Elle positionne Smashy BGs comme le roi de la rue à Marrakech." },
                        { color: "#FF0000", name: "Royal Umami", sub: "Gourmet Intensity", desc: "Un rouge vibrant qui symbolise la passion du goût et l'intensité de la cuisson smashée." },
                        { color: "#111111", name: "Absolute Dark", sub: "Clean Premium", desc: "Garantit que le logo reste l'élément central et le plus contrasté de l'interface." },
                        { color: "#FDFDFD", name: "Strategic White", sub: "Readability Core", desc: "Utilisé pour les contrastes et les espaces de respiration dans l'écosystème digital." }
                    ].map((c, i) => (
                        <div 
                          key={i} 
                          onMouseEnter={() => setActiveColor(c.color)}
                          className={`group/color p-10 rounded-[50px] bg-white/5 border transition-all duration-500 cursor-pointer ${activeColor === c.color ? 'border-white/30 bg-white/10 scale-[1.03]' : 'border-white/10 hover:bg-white/10'}`}
                        >
                            <div className="w-full aspect-video rounded-3xl mb-8 relative overflow-hidden shadow-2xl" style={{ backgroundColor: c.color }}>
                            ...
                            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-[#D4AF37] mb-2 block">{c.sub}</span>
                            <h4 className="text-2xl font-black uppercase tracking-tight mb-4">{c.name}</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                <div className="lg:col-span-6 space-y-12">
                    <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-sm">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.4em]">Physical Branding</span>
                    </div>
                    <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.85]">
                        Le Branding <br/> <span className="text-brand-red italic underline decoration-black/10 decoration-8 underline-offset-[16px]">Habité.</span>
                    </h2>
                    <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed text-justify">
                        L'identité d'une marque ne s'arrête pas aux pixels. Elle prend vie à travers l'uniforme, devenant un porte-drapeau de l'excellence GDC. Chaque détail du textile a été pensé pour refléter la rigueur technique de la création Smashy BGs.
                    </p>
                    <div className="flex items-center gap-10">
                        <div className="flex flex-col">
                            <span className="text-4xl font-black tracking-tighter">Premium</span>
                            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Textile Quality</span>
                        </div>
                        <div className="w-[1px] h-12 bg-black/10 dark:bg-white/10"></div>
                        <div className="flex flex-col">
                            <span className="text-4xl font-black tracking-tighter">Logo R</span>
                            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Iconic Embroidery</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-6 relative">
                    ...
                    <div className="relative rounded-[60px] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.15)] group/img">
                        ...
                        <div className="absolute bottom-10 left-10 p-6 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 text-white">
                            <span className="text-[9px] font-black uppercase tracking-[0.5em] opacity-80">Uniform Specification</span>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <div className="max-w-[1700px] mx-auto">
            <div className="flex flex-col items-center text-center mb-32">
                <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-brand-red/10 border border-brand-red/20 mb-8">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-red">DIGITAL ARCHITECTURE</span>
                </div>
                <h2 className="text-5xl md:text-8xl font-black tracking-tighter uppercase leading-[0.85]">
                    L'Expérience <br/> <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-black dark:from-white dark:to-gray-500 underline decoration-brand-red decoration-4">Sans Friction.</span>
                </h2>
            </div>
                ...
                <div className="lg:col-span-8 bg-white dark:bg-[#080808] rounded-[60px] p-8 md:p-20 border border-black/5 dark:border-white/10 relative overflow-hidden group shadow-xl transition-all hover:border-brand-red/30">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-10">
                            ...
                            <h3 className="text-4xl font-black uppercase tracking-tighter">Commande <br/> en 3 Clics.</h3>
                            <p className="text-lg text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                                GDC a architecturé un parcours utilisateur fluide, réduisant le temps de commande moyen à <strong className="text-black dark:text-white">45 secondes</strong>.
                            </p>
                            <div className="flex flex-wrap gap-3">
                                {["Apple Pay", "CMI Integrated", "Real-time Tracking"].map((t, i) => (
                                    <span key={i} className="px-5 py-2 rounded-xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 text-[9px] font-black uppercase tracking-widest">{t}</span>
                                ))}
                            </div>
                        </div>
                        <div className="relative pointer-events-none">
                            <div className="absolute -inset-10 bg-brand-red/10 rounded-full blur-3xl animate-pulse"></div>
                            <img src="https://groupdigitalconcept.com/wp-content/uploads/2025/12/Design-sans-titre-82.png" className="w-full h-auto relative z-10 transition-transform duration-700 group-hover:scale-110 group-hover:-rotate-3" alt="app ui" />
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 flex flex-col gap-8">
                    <div className="flex-1 bg-brand-red rounded-[60px] p-12 text-white flex flex-col justify-between group overflow-hidden shadow-2xl relative cursor-help">
                        ...
                        <div className="relative z-10">
                            <Activity size={40} className="mb-8 group-hover:animate-pulse" />
                            <h4 className="text-2xl font-black uppercase tracking-widest leading-none mb-4">Haptic <br/> Feedback</h4>
                            <p className="text-white/80 font-bold text-sm">Qualité sensorielle digitale augmentée.</p>
                        </div>
                        <div className="relative z-10 text-6xl font-black tracking-tighter italic opacity-20 group-hover:opacity-40 transition-opacity">SMOOTH.</div>
                    </div>
                    ...
                    <div className="flex-1 bg-black rounded-[60px] p-12 border border-white/5 flex flex-col justify-between group shadow-xl transition-all hover:bg-zinc-900 cursor-default">
                        <div className="flex justify-between items-start">
                            ...
                            <div className="px-3 py-1 rounded-full border border-white/20 text-[8px] font-black uppercase tracking-[0.3em] text-white/40">Secure_v4</div>
                        </div>
                        <div>
                            <h4 className="text-2xl font-black uppercase tracking-tight text-white mb-2">Transactions <br/> Blindées</h4>
                            <p className="text-xs text-white/40 font-medium leading-relaxed">Protocoles bancaires elite et protection des données CNDP.</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <section className="relative py-48 px-4 flex flex-col items-center justify-center text-center overflow-hidden">
         ...
         <div className="relative mb-32 group cursor-default z-10">
            <h2 className="text-[12vw] lg:text-[18rem] font-black uppercase tracking-tighter leading-[0.7] outline-text transition-all duration-1000 group-hover:text-black dark:group-hover:text-white select-none">VOTRE</h2>
            <h2 className="text-[10vw] lg:text-[14rem] font-black uppercase tracking-tighter leading-[0.7] text-brand-red italic select-none">SUCCÈS.</h2>
         </div>

         <div className="flex flex-col items-center gap-16 relative z-10">
            <div className="max-w-2xl space-y-6">
                <p className="text-lg md:text-3xl font-bold uppercase tracking-[0.4em] text-gray-500 dark:text-gray-400">Prêt à dominer l'industrie ?</p>
                <p className="text-xs text-gray-500 uppercase tracking-widest font-black opacity-40">REJOIGNEZ LE CERCLE GDC ELITE • EXCELLENCE MARRAKECH</p>
            </div>
            ...
            >
                ...
                <div className="relative bg-white dark:bg-black px-12 py-8 md:px-20 md:py-12 rounded-full flex items-center gap-10 md:gap-16 transition-colors group-hover:bg-gray-50 dark:group-hover:bg-[#050505]">
                    <div className="text-left">
                        <span className="block text-[10px] font-black uppercase tracking-[0.4em] text-gray-400 mb-1">Démarrer Maintenant</span>
                        <span className="text-xl md:text-4xl font-black uppercase tracking-widest text-black dark:text-white">INITIALISER MON PROJET</span>
                    </div>
