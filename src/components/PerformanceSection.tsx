...
import { Play, Star, Zap, Shield, Smartphone, Globe, Lock, Rocket, BarChart3 } from 'lucide-react';
    ...
    <section className="relative w-full py-24 md:py-32 bg-[#F0F0F2] dark:bg-[#000000] text-black dark:text-white transition-colors duration-500 overflow-hidden border-t border-black/5 dark:border-white/5">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-[1600px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 auto-rows-auto">
            ...
            ">
                <div>
                     <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-red/10 border border-brand-red/20 mb-4">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-brand-red">Excellence Technique</span>
                     </div>
                     <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1] text-black dark:text-white">
                        Performance Technique & SEO : <br className="hidden lg:block"/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-red-600">L'Excellence Digitale</span>
                     </h2>
                </div>
            ...
            <div className="
                col-span-1 md:col-span-2 lg:col-span-7
                bg-white dark:bg-[#080808] 
                rounded-[32px] p-8 md:p-12
                border border-black/5 dark:border-white/10
                flex flex-col
            ...
            ">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h3 className="text-2xl md:text-3xl font-black text-black dark:text-white">Optimisations Clés</h3>
                </div>

                <div className="space-y-6 md:space-y-8 flex-1">
                    {[
                        { 
                            title: "Vitesse ultrarapide", 
                            desc: "Chargement en moins de 1s (testé sur réseaux locaux)",
                        },
                        { 
                            title: "Navigation intuitive", 
                            desc: "Parcours utilisateur optimisé pour une expérience fluide",
                        },
                        { 
                            title: "Compatibilité totale", 
                            desc: "Affichage parfait sur mobile, tablette & desktop",
                        },
                        { 
                            title: "Sécurité renforcée", 
                            desc: "Protection des données et prévention des attaques",
                        },
                        { 
                            title: "Maintenance proactive", 
                            desc: "Mises à jour régulières pour des performances optimales",
                        }
                    ].map((item, index) => (
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-5 flex flex-col gap-6">
                ...
                <div className="
                    ...
                    bg-[#0A0A0A] dark:bg-[#111] 
                    border border-red-900/30
                    shadow-[0_10px_30px_-10px_rgba(220,38,38,0.15)]
                ...
                ">
                    ...
                    <ul className="space-y-5 relative z-10">
                        {[
                            "Référencement naturel intégré dès le développement",
                            "Positionnement sur vos mots-clés stratégiques locaux",
                            "Attraction de trafic qualifié et convertible",
                            "Optimisation technique continue des performances",
                            "Suivi analytique détaillé des résultats"
                        ].map((item, i) => (
                ...
                ">
                    ...
                    <p className="relative z-10 text-lg font-medium text-center italic leading-relaxed text-black dark:text-white">
                        "Votre site web ne se contente pas d'exister – il <strong className="font-black">domine votre marché</strong> grâce à notre expertise en <span className="text-brand-red font-bold not-italic">création site web Marrakech</span>."
                    </p>
                </div>
